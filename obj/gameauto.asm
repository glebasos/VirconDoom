...
__function_main:
  ...
  mov [BP-19], R0
__while_38482_start:
__while_38482_continue:
  mov R0, 1
  jf R0, __while_38482_end
  call __function_get_frame_counter
  mov [BP-20], R0
  mov R0, [BP-20]
  mov R1, [BP-15]
...
__if_38496_end:
  ...
  mov R0, [BP-22]
  bnot R0
  jf R0, __LogicalAnd_ShortCircuit_38650
  mov R1, [BP-34]
  and R0, R1
__LogicalAnd_ShortCircuit_38650:
  mov [BP-47], R0
  mov R0, 0
  mov [BP-48], R0
__if_38655_start:
  mov R0, [global_automapactive]
  jf R0, __LogicalAnd_ShortCircuit_38657
  mov R1, [BP-22]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_38657:
  jf R0, __if_38655_end
__if_38661_start:
  call __function_gamepad_button_r
  mov R1, R0
  igt R1, 0
  mov R0, R1
  jf R0, __if_38661_else
  mov R0, 1
  mov [BP-48], R0
  jmp __if_38661_end
__if_38661_else:
...
__if_38685_start:
  mov R0, [BP-22]
  bnot R0
  jf R0, __if_38685_end
__if_38689_start:
  mov R0, [BP-31]
  jf R0, __if_38689_end
__if_38692_start:
  mov R0, [BP-47]
  jf R0, __if_38692_else
  mov R0, 50
  mov [BP-49], R0
  jmp __if_38692_end
__if_38692_else:
...
__if_38700_start:
  mov R0, [BP-32]
  jf R0, __if_38700_end
__if_38703_start:
  mov R0, [BP-47]
  jf R0, __if_38703_else
  mov R0, -50
  mov [BP-49], R0
  jmp __if_38703_end
__if_38703_else:
...
__if_38713_start:
  ...
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_38716
  call __function_gamepad_button_r
  mov R2, R0
  igt R2, 0
  and R1, R2
...
__if_38729_start:
  mov R1, [global_automapactive]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_38732
  call __function_gamepad_button_l
  mov R2, R0
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_38732:
  mov R0, R1
  jf R0, __if_38729_end
__if_38737_start:
  mov R0, [BP-47]
  jf R0, __if_38737_else
  mov R0, -40
  mov [BP-50], R0
  jmp __if_38737_end
__if_38737_else:
...
__if_38747_start:
  ...
  igt R1, 0
  mov R0, R1
  jf R0, __if_38747_end
__if_38752_start:
  mov R0, [BP-47]
  jf R0, __if_38752_else
  mov R0, 1280
  mov [BP-51], R0
  jmp __if_38752_end
__if_38752_else:
...
__if_38760_start:
  ...
  igt R1, 0
  mov R0, R1
  jf R0, __if_38760_end
__if_38765_start:
  mov R0, [BP-47]
  jf R0, __if_38765_else
  mov R0, -1280
  mov [BP-51], R0
  jmp __if_38765_end
__if_38765_else:
...
__if_38685_end:
  ...
  mov [1616688], R0
  mov R0, [BP-36]
  jt R0, __LogicalOr_ShortCircuit_38792
  mov R1, [BP-44]
  or R0, R1
__LogicalOr_ShortCircuit_38792:
  mov [1616689], R0
  mov R0, [BP-35]
  jt R0, __LogicalOr_ShortCircuit_38798
  mov R1, [BP-43]
  or R0, R1
__LogicalOr_ShortCircuit_38798:
  mov [1616690], R0
  mov R0, 9
  mov [1616691], R0
__if_38803_start:
  mov R0, [BP-22]
  jf R0, __if_38803_else
__if_38806_start:
  mov R0, [BP-42]
  jf R0, __if_38806_end
  mov R0, [BP-1]
  bnot R0
  mov [BP-1], R0
__if_38806_end:
...
__if_38831_start:
  mov R0, [BP-39]
  jf R0, __LogicalAnd_ShortCircuit_38833
  mov R1, [BP-3]
  ilt R1, 2
  and R0, R1
__LogicalAnd_ShortCircuit_38833:
  jf R0, __if_38831_end
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
...
__if_38843_start:
  mov R0, [BP-40]
  jf R0, __LogicalAnd_ShortCircuit_38845
  mov R1, [BP-3]
  igt R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_38845:
  jf R0, __if_38843_end
  mov R0, [BP-3]
  mov R1, R0
  isub R1, 1
  mov [BP-3], R1
...
__if_38855_start:
  mov R0, [BP-45]
  jt R0, __LogicalOr_ShortCircuit_38857
  mov R1, [BP-46]
  or R0, R1
__LogicalOr_ShortCircuit_38857:
  jf R0, __if_38855_end
__if_38860_start:
  mov R0, [BP-46]
  jf R0, __if_38860_else
  mov R0, [global_gamemap]
  mov R1, R0
  iadd R1, 1
...
__if_38889_start:
  mov R0, [BP-41]
  jf R0, __if_38889_end
  mov R0, [1616649]
  mov [BP-56], R0
__if_38896_start:
  mov R0, [1616650]
  ine R0, 9
  jf R0, __if_38896_end
  mov R0, [1616650]
  mov [BP-56], R0
__if_38896_end:
  mov R0, [BP-56]
  ...
  mov [BP-58], R0
__while_38911_start:
__while_38911_continue:
  mov R0, [BP-58]
  ilt R0, 8
  jf R0, __while_38911_end
  mov R0, [BP-57]
  iadd R0, 1
  mov [BP-57], R0
__if_38921_start:
...
__if_38928_start:
  ...
  mov R0, [R0]
  cib R0
  jf R0, __if_38928_end
  jmp __while_38911_end
__if_38928_end:
  mov R0, [BP-58]
  mov R1, R0
  iadd R1, 1
  mov [BP-58], R1
  jmp __while_38911_start
__while_38911_end:
  mov R0, [BP-57]
  mov [1616691], R0
__if_38889_end:
...
__if_39006_start:
  mov R0, [1616627]
  ieq R0, 2
  jf R0, __if_39006_end
  jmp __for_38987_end
__if_39006_end:
__for_38987_continue:
  mov R0, [BP-56]
  mov R1, R0
  iadd R1, 1
  mov [BP-56], R1
  jmp __for_38987_start
__for_38987_end:
...
__if_39018_start:
  mov R0, [1616627]
  ieq R0, 2
  jf R0, __if_39018_end
  call __function_G_LoadLevel
__if_39018_end:
__if_39024_start:
  mov R0, [global_gameexit]
  jf R0, __LogicalAnd_ShortCircuit_39026
  mov R1, [BP-43]
  and R0, R1
__LogicalAnd_ShortCircuit_39026:
  jf R0, __if_39024_end
...
__if_39024_end:
  mov R0, [BP-53]
  ile R0, 1
  jt R0, __LogicalOr_ShortCircuit_39040
  mov R1, [BP-19]
  ige R1, 2
  or R0, R1
__LogicalOr_ShortCircuit_39040:
  mov [BP-54], R0
__if_39043_start:
  mov R0, [BP-54]
  jf R0, __if_39043_else
  mov R0, 0
  mov [global_perf_segs], R0
  mov R0, 0
  mov [global_perf_columns], R0
...
__if_39086_start:
  mov R0, [1616641]
  igt R0, 128
  jt R0, __LogicalOr_ShortCircuit_39102
  mov R1, [1616641]
  and R1, 8
  cib R1
  or R0, R1
__LogicalOr_ShortCircuit_39102:
  jf R0, __if_39086_else
  mov R0, 255
  mov [global_r_fixedlight], R0
  jmp __if_39086_end
__if_39086_else:
...
__if_39151_start:
  mov R0, [1616672]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_39158
  mov R1, [global_gameexit]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_39158:
  jf R0, __if_39151_end
  mov R1, 4
  mov [SP], R1
  mov R1, 2
  mov [SP+1], R1
...
__if_39164_start:
  mov R0, [global_secretmsgtics]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_39170
  mov R1, [global_gameexit]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_39170:
  jf R0, __if_39164_end
  mov R0, __literal_string_39174
  mov [BP-56], R0
  mov R2, [BP-56]
  mov [SP], R2
...
__if_39185_start:
  mov R0, [1616627]
  ieq R0, 1
  jf R0, __if_39185_end
  mov R1, 220
  mov [SP], R1
  mov R1, 250
  mov [SP+1], R1
  mov R1, __literal_string_39193
  mov [SP+2], R1
  call __function_print_at
__if_39185_end:
__if_39194_start:
  mov R0, [BP-16]
  igt R0, 0
  jf R0, __if_39194_end
  mov R1, 270
  mov [SP], R1
  mov R1, 80
  mov [SP+1], R1
  mov R1, __literal_string_39202
  mov [SP+2], R1
  call __function_print_at
  mov R1, 315
  mov [SP], R1
...
__if_39314_start:
  mov R0, [BP-1]
  jf R0, __if_39314_end
  mov R1, 10
  mov [SP], R1
  mov R1, 4
  mov [SP+1], R1
  mov R1, __literal_string_39320
  mov [SP+2], R1
  call __function_print_at
  mov R1, 25
  mov [SP], R1
...
__literal_string_38275:
  string "0"
__literal_string_39174:
  string "A SECRET IS REVEALED!"
__literal_string_39193:
  string "YOU DIED - PRESS B"
__literal_string_39202:
  string "E1M"
__literal_string_39226:
  string "E1M"
__literal_string_39234:
  string "COMPLETE"
__literal_string_39238:
  string "KILLS"
__literal_string_39249:
  string "%"
__literal_string_39253:
  string "ITEMS"
__literal_string_39264:
  string "%"
__literal_string_39268:
  string "SECRET"
__literal_string_39279:
  string "%"
__literal_string_39283:
  string "TIME"
...
__literal_string_39313:
  string "PRESS A"
__literal_string_39320:
  string "X"
__literal_string_39332:
  string "Y"
__literal_string_39344:
  string "Z"
__literal_string_39356:
  string "SEC"
__literal_string_39369:
  string "FRAME"
