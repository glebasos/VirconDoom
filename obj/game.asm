...
__function_main:
  ...
  mov [BP-16], R0
__while_38473_start:
__while_38473_continue:
  mov R0, 1
  jf R0, __while_38473_end
  call __function_get_frame_counter
  mov [BP-17], R0
  mov R0, [BP-17]
  mov R1, [BP-15]
...
__if_38487_end:
  ...
  mov R0, [BP-19]
  bnot R0
  jf R0, __LogicalAnd_ShortCircuit_38641
  mov R1, [BP-31]
  and R0, R1
__LogicalAnd_ShortCircuit_38641:
  mov [BP-44], R0
  mov R0, 0
  mov [BP-45], R0
__if_38646_start:
  mov R0, [global_automapactive]
  jf R0, __LogicalAnd_ShortCircuit_38648
  mov R1, [BP-19]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_38648:
  jf R0, __if_38646_end
__if_38652_start:
  call __function_gamepad_button_r
  mov R1, R0
  igt R1, 0
  mov R0, R1
  jf R0, __if_38652_else
  mov R0, 1
  mov [BP-45], R0
  jmp __if_38652_end
__if_38652_else:
...
__if_38680_start:
  mov R0, [BP-28]
  jf R0, __if_38680_end
__if_38683_start:
  mov R0, [BP-44]
  jf R0, __if_38683_else
  mov R0, 50
  mov [BP-46], R0
  jmp __if_38683_end
__if_38683_else:
...
__if_38691_start:
  mov R0, [BP-29]
  jf R0, __if_38691_end
__if_38694_start:
  mov R0, [BP-44]
  jf R0, __if_38694_else
  mov R0, -50
  mov [BP-46], R0
  jmp __if_38694_end
__if_38694_else:
...
__if_38704_start:
  ...
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_38707
  call __function_gamepad_button_r
  mov R2, R0
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_38707:
  mov R0, R1
  jf R0, __if_38704_end
__if_38712_start:
  mov R0, [BP-44]
  jf R0, __if_38712_else
  mov R0, 40
  mov [BP-47], R0
  jmp __if_38712_end
__if_38712_else:
...
__if_38720_start:
  mov R1, [global_automapactive]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_38723
  call __function_gamepad_button_l
  mov R2, R0
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_38723:
  mov R0, R1
  jf R0, __if_38720_end
__if_38728_start:
  mov R0, [BP-44]
  jf R0, __if_38728_else
  mov R0, -40
  mov [BP-47], R0
  jmp __if_38728_end
__if_38728_else:
...
__if_38738_start:
  ...
  igt R1, 0
  mov R0, R1
  jf R0, __if_38738_end
__if_38743_start:
  mov R0, [BP-44]
  jf R0, __if_38743_else
  mov R0, 1280
  mov [BP-48], R0
  jmp __if_38743_end
__if_38743_else:
...
__if_38751_start:
  ...
  igt R1, 0
  mov R0, R1
  jf R0, __if_38751_end
__if_38756_start:
  mov R0, [BP-44]
  jf R0, __if_38756_else
  mov R0, -1280
  mov [BP-48], R0
  jmp __if_38756_end
__if_38756_else:
...
__if_38676_end:
  ...
  mov [1616688], R0
  mov R0, [BP-33]
  jt R0, __LogicalOr_ShortCircuit_38783
  mov R1, [BP-41]
  or R0, R1
__LogicalOr_ShortCircuit_38783:
  mov [1616689], R0
  mov R0, [BP-32]
  jt R0, __LogicalOr_ShortCircuit_38789
  mov R1, [BP-40]
  or R0, R1
__LogicalOr_ShortCircuit_38789:
  mov [1616690], R0
  mov R0, 9
  mov [1616691], R0
__if_38794_start:
  mov R0, [BP-19]
  jf R0, __if_38794_else
__if_38797_start:
  mov R0, [BP-39]
  jf R0, __if_38797_end
  mov R0, [BP-1]
  bnot R0
  mov [BP-1], R0
__if_38797_end:
...
__if_38822_start:
  mov R0, [BP-36]
  jf R0, __LogicalAnd_ShortCircuit_38824
  mov R1, [BP-3]
  ilt R1, 2
  and R0, R1
__LogicalAnd_ShortCircuit_38824:
  jf R0, __if_38822_end
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
...
__if_38846_start:
  mov R0, [BP-42]
  jt R0, __LogicalOr_ShortCircuit_38848
  mov R1, [BP-43]
  or R0, R1
__LogicalOr_ShortCircuit_38848:
  jf R0, __if_38846_end
__if_38851_start:
  mov R0, [BP-43]
  jf R0, __if_38851_else
  mov R0, [global_gamemap]
  mov R1, R0
  iadd R1, 1
...
__if_38880_start:
  mov R0, [BP-38]
  jf R0, __if_38880_end
  mov R0, [1616649]
  mov [BP-50], R0
__if_38887_start:
  mov R0, [1616650]
  ine R0, 9
  jf R0, __if_38887_end
  mov R0, [1616650]
  mov [BP-50], R0
__if_38887_end:
  mov R0, [BP-50]
  ...
  mov [BP-52], R0
__while_38902_start:
__while_38902_continue:
  mov R0, [BP-52]
  ilt R0, 8
  jf R0, __while_38902_end
  mov R0, [BP-51]
  iadd R0, 1
  mov [BP-51], R0
__if_38912_start:
...
__if_38919_start:
  ...
  mov R0, [R0]
  cib R0
  jf R0, __if_38919_end
  jmp __while_38902_end
__if_38919_end:
  mov R0, [BP-52]
  mov R1, R0
  iadd R1, 1
  mov [BP-52], R1
  jmp __while_38902_start
__while_38902_end:
  mov R0, [BP-51]
  mov [1616691], R0
__if_38880_end:
...
__if_38955_start:
  mov R0, [global_gameexit]
  jf R0, __LogicalAnd_ShortCircuit_38957
  mov R1, [BP-40]
  and R0, R1
__LogicalAnd_ShortCircuit_38957:
...
__if_39004_start:
  mov R0, [1616641]
  igt R0, 128
  jt R0, __LogicalOr_ShortCircuit_39020
  mov R1, [1616641]
  and R1, 8
  cib R1
  or R0, R1
__LogicalOr_ShortCircuit_39020:
  jf R0, __if_39004_else
  mov R0, 255
  mov [global_r_fixedlight], R0
  jmp __if_39004_end
__if_39004_else:
...
__if_39069_start:
  mov R0, [1616672]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_39076
  mov R1, [global_gameexit]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_39076:
  jf R0, __if_39069_end
  mov R1, 4
  mov [SP], R1
  mov R1, 2
  mov [SP+1], R1
...
__if_39082_start:
  mov R0, [global_secretmsgtics]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_39088
  mov R1, [global_gameexit]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_39088:
  jf R0, __if_39082_end
  mov R0, __literal_string_39092
  mov [BP-50], R0
  mov R2, [BP-50]
  mov [SP], R2
...
__if_39103_start:
  mov R0, [1616627]
  ieq R0, 1
  jf R0, __if_39103_end
  mov R1, 220
  mov [SP], R1
  mov R1, 250
  mov [SP+1], R1
  mov R1, __literal_string_39111
  mov [SP+2], R1
  call __function_print_at
__if_39103_end:
__if_39112_start:
  mov R0, [BP-16]
  igt R0, 0
  jf R0, __if_39112_end
  mov R1, 270
  mov [SP], R1
  mov R1, 80
  mov [SP+1], R1
  mov R1, __literal_string_39120
  mov [SP+2], R1
  call __function_print_at
  mov R1, 315
  mov [SP], R1
...
__if_39127_start:
  ...
  mov R1, 275
  mov [SP+1], R1
  mov R1, __literal_string_39231
  mov [SP+2], R1
  call __function_print_at
__if_39127_end:
__if_39232_start:
  mov R0, [BP-1]
  jf R0, __if_39232_end
  mov R1, 10
  mov [SP], R1
  mov R1, 4
  mov [SP+1], R1
  mov R1, __literal_string_39238
  mov [SP+2], R1
  call __function_print_at
  mov R1, 25
  mov [SP], R1
...
__if_39342_start:
  mov R0, [BP-2]
  jf R0, __if_39342_else
  mov R1, 550
  mov [SP], R1
  mov R1, 24
  mov [SP+1], R1
  mov R1, __literal_string_39347
  mov [SP+2], R1
  call __function_print_at
  jmp __if_39342_end
__if_39342_else:
...
__literal_string_38275:
  string "0"
__literal_string_39092:
  string "A SECRET IS REVEALED!"
__literal_string_39111:
  string "YOU DIED - PRESS B"
__literal_string_39120:
  string "E1M"
__literal_string_39144:
  string "E1M"
__literal_string_39152:
  string "COMPLETE"
__literal_string_39156:
  string "KILLS"
__literal_string_39167:
  string "%"
__literal_string_39171:
  string "ITEMS"
__literal_string_39182:
  string "%"
__literal_string_39186:
  string "SECRET"
__literal_string_39197:
  string "%"
__literal_string_39201:
  string "TIME"
__literal_string_39209:
  string "PAR"
__literal_string_39223:
  string "ENTERING  E1M"
__literal_string_39231:
  string "PRESS A"
__literal_string_39238:
  string "X"
__literal_string_39250:
  string "Y"
__literal_string_39262:
  string "Z"
__literal_string_39274:
  string "SEC"
__literal_string_39287:
  string "FRAME"
__literal_string_39295:
  string "ZONE"
__literal_string_39305:
  string "SEGS"
__literal_string_39313:
  string "COLS"
__literal_string_39321:
  string "DRAWS"
__literal_string_39329:
  string "VS"
__literal_string_39337:
  string "DROP"
__literal_string_39347:
  string "LO"
__literal_string_39351:
  string "HI"
__literal_string_39355:
  string "PLN"
__literal_string_39363:
  string "FIL"
__literal_string_39371:
  string "SPR"
__literal_string_39379:
  string "MSK"
__literal_string_39387:
  string "SIZE"
