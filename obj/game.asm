...
__if_28554_end:
__if_28541_end:
__for_28505_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_28505_start
__for_28505_end:
...
__if_28745_start:
  ...
  cib R0
  jt R0, __LogicalOr_ShortCircuit_28747
  mov R1, [global_am_lastlevelinit]
  ieq R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_28747:
  jf R0, __if_28745_end
...
__if_28844_start:
  mov R0, [BP+2]
  ilt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_28849
  mov R1, [BP+4]
  ilt R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_28849:
  jf R0, __if_28844_end
  jmp __function_AM_DrawScreenLine_return
__if_28844_end:
__if_28853_start:
  mov R0, [BP+2]
  igt R0, 640
  jf R0, __LogicalAnd_ShortCircuit_28858
  mov R1, [BP+4]
  igt R1, 640
  and R0, R1
__LogicalAnd_ShortCircuit_28858:
  jf R0, __if_28853_end
  jmp __function_AM_DrawScreenLine_return
__if_28853_end:
__if_28862_start:
  mov R0, [BP+3]
  ilt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_28867
  mov R1, [BP+5]
  ilt R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_28867:
...
__if_28871_start:
  mov R0, [BP+3]
  igt R0, 296
  jf R0, __LogicalAnd_ShortCircuit_28876
  mov R1, [BP+5]
  igt R1, 296
  and R0, R1
__LogicalAnd_ShortCircuit_28876:
  jf R0, __if_28871_end
  jmp __function_AM_DrawScreenLine_return
__if_28871_end:
  mov R0, [BP+4]
  mov R1, [BP+2]
...
__if_28914_start:
  mov R0, [BP-1]
  fne R0, 0.000000
  jt R0, __LogicalOr_ShortCircuit_28919
  mov R1, [BP-2]
  fne R1, 0.000000
  or R0, R1
__LogicalOr_ShortCircuit_28919:
  jf R0, __if_28914_end
  mov R2, [BP-2]
  mov [SP], R2
  mov R2, [BP-1]
  mov [SP+1], R2
...
__if_28976_start:
  ...
  and R0, 256
  ieq R0, 0
  jf R0, __if_28976_end
  jmp __for_28960_continue
__if_28976_end:
__if_28985_start:
  mov R1, [BP-2]
  iadd R1, 4
...
__if_29023_end:
__if_29011_end:
__for_28960_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_28960_start
__for_28960_end:
...
__for_29120_start:
  ...
  mov [SP+4], R1
  call __function_AM_DrawMline
__for_29120_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_29120_start
__for_29120_end:
...
__if_29247_start:
  ...
  jmp __for_29237_end
__if_29247_end:
__for_29237_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_29237_start
__for_29237_end:
...
__function_main:
  ...
  mov [BP-13], R0
__while_29352_start:
__while_29352_continue:
  mov R0, 1
  jf R0, __while_29352_end
  call __function_get_frame_counter
  mov [BP-14], R0
  mov R0, [BP-14]
  mov R1, [BP-13]
...
__if_29366_end:
  ...
  mov R0, [BP-16]
  bnot R0
  jf R0, __LogicalAnd_ShortCircuit_29486
  mov R1, [BP-26]
  and R0, R1
__LogicalAnd_ShortCircuit_29486:
  mov [BP-35], R0
  mov R0, 0
  mov [BP-36], R0
__if_29491_start:
  mov R0, [global_automapactive]
  jf R0, __LogicalAnd_ShortCircuit_29493
  mov R1, [BP-16]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_29493:
...
__if_29521_start:
  mov R0, [BP-16]
  bnot R0
  jf R0, __if_29521_end
__if_29525_start:
  mov R0, [BP-23]
  jf R0, __if_29525_end
__if_29528_start:
  mov R0, [BP-35]
  jf R0, __if_29528_else
  mov R0, 50
  mov [BP-37], R0
  jmp __if_29528_end
__if_29528_else:
...
__if_29549_start:
  ...
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_29552
  call __function_gamepad_button_r
  mov R2, R0
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_29552:
  mov R0, R1
  jf R0, __if_29549_end
__if_29557_start:
  mov R0, [BP-35]
  jf R0, __if_29557_else
  mov R0, 40
  mov [BP-38], R0
  jmp __if_29557_end
__if_29557_else:
...
__if_29565_start:
  mov R1, [global_automapactive]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_29568
  call __function_gamepad_button_l
  mov R2, R0
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_29568:
  mov R0, R1
  jf R0, __if_29565_end
__if_29573_start:
  mov R0, [BP-35]
  jf R0, __if_29573_else
  mov R0, -40
  mov [BP-38], R0
  jmp __if_29573_end
__if_29573_else:
...
__if_29521_end:
  ...
  mov [1616675], R0
  mov R0, [BP-28]
  jt R0, __LogicalOr_ShortCircuit_29628
  mov R1, [BP-34]
  or R0, R1
__LogicalOr_ShortCircuit_29628:
  mov [1616676], R0
  mov R0, [BP-27]
  jt R0, __LogicalOr_ShortCircuit_29634
  mov R1, [BP-33]
  or R0, R1
__LogicalOr_ShortCircuit_29634:
  mov [1616677], R0
  mov R0, 9
  mov [1616678], R0
__if_29639_start:
  mov R0, [BP-16]
  jf R0, __if_29639_else
__if_29642_start:
  mov R0, [BP-32]
  jf R0, __if_29642_end
  mov R0, [BP-1]
  bnot R0
  mov [BP-1], R0
__if_29642_end:
...
__if_29667_start:
  mov R0, [BP-29]
  jf R0, __LogicalAnd_ShortCircuit_29669
  mov R1, [BP-3]
  ilt R1, 2
  and R0, R1
__LogicalAnd_ShortCircuit_29669:
...
__if_29679_start:
  mov R0, [BP-30]
  jf R0, __LogicalAnd_ShortCircuit_29681
  mov R1, [BP-3]
  igt R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_29681:
  jf R0, __if_29679_end
  mov R0, [BP-3]
  mov R1, R0
  isub R1, 1
  mov [BP-3], R1
...
__if_29698_end:
  ...
  mov [BP-43], R0
__while_29713_start:
__while_29713_continue:
  mov R0, [BP-43]
  ilt R0, 8
  jf R0, __while_29713_end
  mov R0, [BP-42]
  iadd R0, 1
  mov [BP-42], R0
__if_29723_start:
...
__if_29730_start:
  ...
  mov R0, [R0]
  cib R0
  jf R0, __if_29730_end
  jmp __while_29713_end
__if_29730_end:
  mov R0, [BP-43]
  mov R1, R0
  iadd R1, 1
  mov [BP-43], R1
  jmp __while_29713_start
__while_29713_end:
  mov R0, [BP-42]
  mov [1616678], R0
__if_29691_end:
...
__if_29758_start:
  mov R0, [1616622]
  ieq R0, 2
  jf R0, __if_29758_end
  call __function_G_LoadLevel
__if_29758_end:
__if_29764_start:
  mov R0, [global_gameexit]
  jf R0, __LogicalAnd_ShortCircuit_29766
  mov R1, [BP-33]
  and R0, R1
__LogicalAnd_ShortCircuit_29766:
  jf R0, __if_29764_end
  call __function_G_LoadLevel
__if_29764_end:
  mov R0, 0
  mov [global_perf_segs], R0
