...
__function_main:
  ...
  mov [BP-18], R0
__while_38479_start:
__while_38479_continue:
  mov R0, 1
  jf R0, __while_38479_end
  call __function_get_frame_counter
  mov [BP-19], R0
  mov R0, [BP-19]
  mov R1, [BP-15]
...
__if_38493_end:
  ...
  mov R0, [BP-21]
  bnot R0
  jf R0, __LogicalAnd_ShortCircuit_38647
  mov R1, [BP-33]
  and R0, R1
__LogicalAnd_ShortCircuit_38647:
  mov [BP-46], R0
  mov R0, 0
  mov [BP-47], R0
__if_38652_start:
  mov R0, [global_automapactive]
  jf R0, __LogicalAnd_ShortCircuit_38654
  mov R1, [BP-21]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_38654:
  jf R0, __if_38652_end
__if_38658_start:
  call __function_gamepad_button_r
  mov R1, R0
  igt R1, 0
  mov R0, R1
  jf R0, __if_38658_else
  mov R0, 1
  mov [BP-47], R0
  jmp __if_38658_end
__if_38658_else:
...
__if_38682_start:
  mov R0, [BP-21]
  bnot R0
  jf R0, __if_38682_end
__if_38686_start:
  mov R0, [BP-30]
  jf R0, __if_38686_end
__if_38689_start:
  mov R0, [BP-46]
  jf R0, __if_38689_else
  mov R0, 50
  mov [BP-48], R0
  jmp __if_38689_end
__if_38689_else:
...
__if_38710_start:
  ...
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_38713
  call __function_gamepad_button_r
  mov R2, R0
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_38713:
  mov R0, R1
  jf R0, __if_38710_end
__if_38718_start:
  mov R0, [BP-46]
  jf R0, __if_38718_else
  mov R0, 40
  mov [BP-49], R0
  jmp __if_38718_end
__if_38718_else:
...
__if_38726_start:
  mov R1, [global_automapactive]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_38729
  call __function_gamepad_button_l
  mov R2, R0
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_38729:
  mov R0, R1
  jf R0, __if_38726_end
__if_38734_start:
  mov R0, [BP-46]
  jf R0, __if_38734_else
  mov R0, -40
  mov [BP-49], R0
  jmp __if_38734_end
__if_38734_else:
...
__if_38744_start:
  ...
  igt R1, 0
  mov R0, R1
  jf R0, __if_38744_end
__if_38749_start:
  mov R0, [BP-46]
  jf R0, __if_38749_else
  mov R0, 1280
  mov [BP-50], R0
  jmp __if_38749_end
__if_38749_else:
...
__if_38828_start:
  mov R0, [BP-38]
  jf R0, __LogicalAnd_ShortCircuit_38830
  mov R1, [BP-3]
  ilt R1, 2
  and R0, R1
__LogicalAnd_ShortCircuit_38830:
  jf R0, __if_38828_end
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
...
__if_38840_start:
  mov R0, [BP-39]
  jf R0, __LogicalAnd_ShortCircuit_38842
  mov R1, [BP-3]
  igt R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_38842:
  jf R0, __if_38840_end
  mov R0, [BP-3]
  mov R1, R0
  isub R1, 1
  mov [BP-3], R1
...
__if_38852_start:
  mov R0, [BP-44]
  jt R0, __LogicalOr_ShortCircuit_38854
  mov R1, [BP-45]
  or R0, R1
__LogicalOr_ShortCircuit_38854:
  jf R0, __if_38852_end
__if_38857_start:
  mov R0, [BP-45]
  jf R0, __if_38857_else
  mov R0, [global_gamemap]
  mov R1, R0
  iadd R1, 1
...
__if_38886_start:
  mov R0, [BP-40]
  jf R0, __if_38886_end
  mov R0, [1616649]
  mov [BP-54], R0
__if_38893_start:
  mov R0, [1616650]
  ine R0, 9
  jf R0, __if_38893_end
  mov R0, [1616650]
  mov [BP-54], R0
__if_38893_end:
  mov R0, [BP-54]
  ...
  mov [BP-56], R0
__while_38908_start:
__while_38908_continue:
  mov R0, [BP-56]
  ilt R0, 8
  jf R0, __while_38908_end
  mov R0, [BP-55]
  iadd R0, 1
  mov [BP-55], R0
__if_38918_start:
...
__if_38925_start:
  ...
  mov R0, [R0]
  cib R0
  jf R0, __if_38925_end
  jmp __while_38908_end
__if_38925_end:
  mov R0, [BP-56]
  mov R1, R0
  iadd R1, 1
  mov [BP-56], R1
  jmp __while_38908_start
__while_38908_end:
  mov R0, [BP-55]
  mov [1616691], R0
__if_38886_end:
...
__if_39003_start:
  mov R0, [1616627]
  ieq R0, 2
  jf R0, __if_39003_end
  jmp __for_38984_end
__if_39003_end:
__for_38984_continue:
  mov R0, [BP-54]
  mov R1, R0
  iadd R1, 1
  mov [BP-54], R1
  jmp __for_38984_start
__for_38984_end:
...
__if_39015_start:
  mov R0, [1616627]
  ieq R0, 2
  jf R0, __if_39015_end
  call __function_G_LoadLevel
__if_39015_end:
__if_39021_start:
  mov R0, [global_gameexit]
  jf R0, __LogicalAnd_ShortCircuit_39023
  mov R1, [BP-42]
  and R0, R1
__LogicalAnd_ShortCircuit_39023:
...
__if_39070_start:
  mov R0, [1616641]
  igt R0, 128
  jt R0, __LogicalOr_ShortCircuit_39086
  mov R1, [1616641]
  and R1, 8
  cib R1
  or R0, R1
__LogicalOr_ShortCircuit_39086:
  jf R0, __if_39070_else
  mov R0, 255
  mov [global_r_fixedlight], R0
  jmp __if_39070_end
__if_39070_else:
...
__if_39135_start:
  mov R0, [1616672]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_39142
  mov R1, [global_gameexit]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_39142:
  jf R0, __if_39135_end
  mov R1, 4
  mov [SP], R1
  mov R1, 2
  mov [SP+1], R1
...
__if_39148_start:
  mov R0, [global_secretmsgtics]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_39154
  mov R1, [global_gameexit]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_39154:
  jf R0, __if_39148_end
  mov R0, __literal_string_39158
  mov [BP-54], R0
  mov R2, [BP-54]
  mov [SP], R2
...
__if_39169_start:
  mov R0, [1616627]
  ieq R0, 1
  jf R0, __if_39169_end
  mov R1, 220
  mov [SP], R1
  mov R1, 250
  mov [SP+1], R1
  mov R1, __literal_string_39177
  mov [SP+2], R1
  call __function_print_at
__if_39169_end:
__if_39178_start:
...
__if_39193_start:
  ...
  mov R1, 275
  mov [SP+1], R1
  mov R1, __literal_string_39297
  mov [SP+2], R1
  call __function_print_at
__if_39193_end:
__if_39298_start:
  mov R0, [BP-1]
  jf R0, __if_39298_end
  mov R1, 10
  mov [SP], R1
  mov R1, 4
  mov [SP+1], R1
  mov R1, __literal_string_39304
  mov [SP+2], R1
  call __function_print_at
  mov R1, 25
  mov [SP], R1
...
__if_39408_start:
  mov R0, [BP-2]
  jf R0, __if_39408_else
  mov R1, 550
  mov [SP], R1
  mov R1, 24
  mov [SP+1], R1
  mov R1, __literal_string_39413
  mov [SP+2], R1
  call __function_print_at
  jmp __if_39408_end
__if_39408_else:
...
__literal_string_38275:
  string "0"
__literal_string_39158:
  string "A SECRET IS REVEALED!"
__literal_string_39177:
  string "YOU DIED - PRESS B"
__literal_string_39186:
  string "E1M"
__literal_string_39210:
  string "E1M"
__literal_string_39218:
  string "COMPLETE"
__literal_string_39222:
  string "KILLS"
__literal_string_39233:
  string "%"
__literal_string_39237:
  string "ITEMS"
__literal_string_39248:
  string "%"
__literal_string_39252:
  string "SECRET"
__literal_string_39263:
  string "%"
__literal_string_39267:
  string "TIME"
__literal_string_39275:
  string "PAR"
__literal_string_39289:
  string "ENTERING  E1M"
__literal_string_39297:
  string "PRESS A"
__literal_string_39304:
  string "X"
__literal_string_39316:
  string "Y"
__literal_string_39328:
  string "Z"
__literal_string_39340:
  string "SEC"
__literal_string_39353:
  string "FRAME"
__literal_string_39361:
  string "ZONE"
...
__literal_string_39403:
  string "DROP"
__literal_string_39413:
  string "LO"
__literal_string_39417:
  string "HI"
__literal_string_39421:
  string "PLN"
__literal_string_39429:
  string "FIL"
