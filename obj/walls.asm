...
__if_6985_start:
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_6991
  mov R1, [BP+3]
  mov R3, [BP-1]
  iadd R3, 1
  mov R2, [R3]
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_6991:
  jf R0, __LogicalAnd_ShortCircuit_6996
  mov R1, [BP+4]
  mov R3, [BP-1]
  iadd R3, 2
  mov R2, [R3]
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_6996:
  jf R0, __if_6985_end
  mov R0, [BP-1]
...
__function_R_MakeSpans:
  ...
  isub SP, 5
__while_7275_start:
__while_7275_continue:
  mov R0, [BP+3]
  mov R1, [BP+5]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7280
  mov R1, [BP+3]
  mov R2, [BP+4]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7280:
  jf R0, __while_7275_end
  ...
  iadd R1, 1
  mov [BP+3], R1
  jmp __while_7275_start
__while_7275_end:
__while_7304_start:
__while_7304_continue:
  mov R0, [BP+4]
  mov R1, [BP+6]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7309
  mov R1, [BP+4]
  mov R2, [BP+3]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7309:
  jf R0, __while_7304_end
  mov R1, global_spanstart
  mov R2, [BP+4]
  iadd R1, R2
  mov R1, [R1]
...
__while_7333_continue:
  ...
  mov R1, [BP+3]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7338
  mov R1, [BP+5]
  mov R2, [BP+6]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7338:
...
__while_7333_end:
__while_7349_start:
__while_7349_continue:
  mov R0, [BP+6]
  mov R1, [BP+4]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7354
  mov R1, [BP+6]
  mov R2, [BP+5]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7354:
  jf R0, __while_7349_end
  mov R0, [BP+2]
  mov R1, global_spanstart
  mov R2, [BP+6]
  iadd R1, R2
...
__if_7439_start:
  mov R0, [BP-6]
  ine R0, 255
  jf R0, __LogicalAnd_ShortCircuit_7444
  mov R1, [BP-6]
  mov R2, [BP-7]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7444:
  jf R0, __if_7439_end
...
__if_8227_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8239
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_8239:
  jf R0, __if_8227_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_8506_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8518
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_8518:
  jf R0, __if_8506_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_8803_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8815
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_8815:
  jf R0, __if_8803_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_9379_start:
  ...
  mov R0, [R1]
  ieq R0, 53
  jf R0, __LogicalAnd_ShortCircuit_9386
  mov R2, [global_backsector]
  iadd R2, 3
  mov R1, [R2]
  ieq R1, 53
  and R0, R1
__LogicalAnd_ShortCircuit_9386:
  jf R0, __if_9379_end
  mov R1, [global_backsector]
  iadd R1, 1
  mov R0, [R1]
...
__if_9688_start:
  ...
  mov R1, [global_viewz]
  ile R0, R1
  jf R0, __LogicalAnd_ShortCircuit_9695
  mov R2, [global_frontsector]
  iadd R2, 3
  mov R1, [R2]
  ine R1, 53
  and R0, R1
__LogicalAnd_ShortCircuit_9695:
  jf R0, __if_9688_end
  mov R0, 0
  mov [global_markceiling], R0
__if_9688_end:
...
__if_9874_start:
  mov R0, [global_markceiling]
  jf R0, __LogicalAnd_ShortCircuit_9876
  mov R1, [global_ceilingplane]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_9876:
  jf R0, __if_9874_else
...
__if_9891_start:
  mov R0, [global_markfloor]
  jf R0, __LogicalAnd_ShortCircuit_9893
  mov R1, [global_floorplane]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_9893:
  jf R0, __if_9891_else
...
__if_9909_start:
  ...
  and R0, 2
  cib R0
  jt R0, __LogicalOr_ShortCircuit_9916
  mov R1, [global_maskedtexture]
  or R0, R1
__LogicalOr_ShortCircuit_9916:
  jf R0, __LogicalAnd_ShortCircuit_9918
  mov R2, [BP-7]
  iadd R2, 9
  mov R1, [R2]
  ieq R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_9918:
  jf R0, __if_9909_end
__if_9924_start:
  mov R0, [global_opening_used]
  mov R1, [global_rw_stopx]
...
__if_9980_start:
  ...
  and R0, 1
  cib R0
  jt R0, __LogicalOr_ShortCircuit_9987
  mov R1, [global_maskedtexture]
  or R0, R1
__LogicalOr_ShortCircuit_9987:
  jf R0, __LogicalAnd_ShortCircuit_9989
  mov R2, [BP-7]
  iadd R2, 10
  mov R1, [R2]
  ieq R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_9989:
  jf R0, __if_9980_end
__if_9995_start:
  mov R0, [global_opening_used]
  mov R1, [global_rw_stopx]
...
__if_10051_start:
  mov R0, [global_maskedtexture]
  jf R0, __LogicalAnd_ShortCircuit_10053
  mov R2, [BP-7]
  iadd R2, 6
  mov R1, [R2]
  and R1, 2
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_10053:
  jf R0, __if_10051_end
  mov R1, [BP-7]
  iadd R1, 6
  mov R0, [R1]
  or R0, 2
...
__if_10361_start:
  mov R0, [BP-8]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_10366
  mov R1, [BP-17]
  mov R2, [BP-8]
  mov R3, [BP-5]
  iadd R2, R3
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_10366:
...
__if_10378_start:
  mov R0, [BP-9]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_10383
  mov R1, [BP-16]
  mov R2, [BP-9]
  mov R3, [BP-5]
  iadd R2, R3
  ...
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_10383:
  jf R0, __if_10378_end
  mov R0, [BP-9]
  mov R1, [BP-5]
  iadd R0, R1
  mov R0, [R0]
...
__if_10279_end:
  ...
  iadd R0, R1
  mov [BP-3], R0
__for_10269_continue:
  mov R0, [BP-5]
  mov R1, R0
  iadd R1, 1
  mov [BP-5], R1
  jmp __for_10269_start
__for_10269_end:
...
__if_10556_start:
  mov R0, [BP-3]
  bnot R0
  jf R0, __if_10556_end
__if_10560_start:
  mov R0, [BP+2]
  mov R1, [BP-1]
  ile R0, R1
  jf R0, __if_10560_end
  mov R0, [BP-4]
  igt R0, 0
...
__for_11095_start:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __for_11095_end
  mov R1, [BP-1]
  mov [SP], R1
  call __function_R_ProjectSprite
__for_11095_continue:
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
  mov [BP-1], R0
  jmp __for_11095_start
__for_11095_end:
...
__for_11119_start:
  ...
  mov R1, [global_visspr_count]
  ilt R0, R1
  jf R0, __for_11119_end
  mov R0, [BP-1]
  mov R1, global_visspr_order
  mov R2, [BP-1]
  iadd R1, R2
  mov [R1], R0
__for_11119_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_11119_start
__for_11119_end:
  mov R0, 0
  mov [BP-1], R0
__for_11133_start:
...
__if_11168_start:
  ...
  mov [BP-3], R0
__if_11168_end:
__for_11156_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_11156_start
__for_11156_end:
...
__if_11316_start:
  mov R0, [BP-13]
  ige R0, 0
  jf R0, __LogicalAnd_ShortCircuit_11321
  mov R1, [BP-13]
  mov R2, [BP-5]
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_11321:
  jf R0, __if_11316_end
  mov R0, [BP-9]
  iadd R0, 65536
  isub R0, 1
  shl R0, -16
...
__if_11515_start:
  ...
  mov R1, [R2]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_11523
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [BP+2]
  ...
  ilt R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_11523:
  jt R0, __LogicalOr_ShortCircuit_11536
  mov R2, [BP-1]
  iadd R2, 6
  mov R1, [R2]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_11531
  mov R3, [BP-1]
  iadd R3, 11
  mov R2, [R3]
  ieq R2, -1
  and R1, R2
__LogicalAnd_ShortCircuit_11531:
  or R0, R1
__LogicalOr_ShortCircuit_11536:
  jf R0, __if_11515_end
  jmp __for_11497_continue
__if_11515_end:
__if_11538_start:
  mov R1, [BP-1]
  iadd R1, 1
...
__if_11590_start:
  ...
  mov R2, [R3]
  ilt R1, R2
  jt R1, __LogicalOr_ShortCircuit_11609
  mov R2, [BP-7]
  mov R4, [BP+2]
  iadd R4, 7
  mov R3, [R4]
  ilt R2, R3
  jf R2, __LogicalAnd_ShortCircuit_11608
  mov R5, [BP+2]
  iadd R5, 2
  mov R4, [R5]
  mov [SP], R4
  ...
  bnot R3
  and R2, R3
__LogicalAnd_ShortCircuit_11608:
  or R1, R2
__LogicalOr_ShortCircuit_11609:
  mov R0, R1
  jf R0, __if_11590_end
__if_11611_start:
  mov R1, [BP-1]
  iadd R1, 11
  mov R0, [R1]
...
__if_11657_start:
  ...
  mov [R1], R0
__if_11657_end:
__for_11648_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_11648_start
__for_11648_end:
  jmp __if_11643_end
__if_11643_else:
__if_11672_start:
...
__if_11686_start:
  ...
  mov [R1], R0
__if_11686_end:
__for_11677_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_11677_start
__for_11677_end:
  jmp __if_11672_end
__if_11672_else:
__if_11701_start:
...
__if_11731_start:
  ...
  mov [R1], R0
__if_11731_end:
__for_11706_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_11706_start
__for_11706_end:
__if_11701_end:
__if_11672_end:
__if_11643_end:
__for_11497_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_11497_start
__for_11497_end:
  mov R1, [BP+2]
  mov R0, [R1]
  mov [BP-3], R0
...
__if_11770_start:
  ...
  mov [R1], R0
__if_11770_end:
__for_11746_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_11746_start
__for_11746_end:
  mov R0, global_spr_clipbot
  mov [global_mfloorclip], R0
  mov R0, global_spr_cliptop
...
__if_12148_end:
__for_12138_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12138_start
__for_12138_end:
...
__for_12171_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12171_start
__for_12171_end:
  mov R0, [global_ds_count]
  isub R0, 1
  mov [BP-2], R0
...
__if_12205_start:
  ...
  call __function_R_RenderMaskedSegRange
__if_12205_end:
__for_12187_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_12187_start
__for_12187_end:
...
__while_12269_start:
__while_12269_continue:
  mov R0, [BP-1]
  mov R1, [BP-2]
  ine R0, R1
  jf R0, __while_12269_end
  lea R13, [BP-1]
  mov R13, [R13]
  mov R12, [BP-1]
  isub R12, 2
...
__if_12337_start:
  ...
  iadd R1, 1
  mov [R1], R0
  jmp __label_12359_crunch
__if_12337_end:
  jmp __while_12312_start
__while_12312_end:
  mov R2, [BP-1]
  iadd R2, 1
  mov R1, [R2]
  ...
  iadd R1, 1
  mov [R1], R0
__label_12359_crunch:
__if_12360_start:
  mov R0, [BP-1]
  mov R1, [BP-2]
  ieq R0, R1
  jf R0, __if_12360_end
  jmp __function_R_ClipSolidWallSegment_return
__if_12360_end:
__while_12365_start:
__while_12365_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 2
  mov [BP-1], R1
...
__while_12391_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_12391_end
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 2
  mov [BP-1], R1
  jmp __while_12391_start
__while_12391_end:
__if_12400_start:
  mov R0, [BP+2]
  mov R2, [BP-1]
...
__if_12678_start:
  ...
  ine R0, -1
  bnot R0
  jf R0, __if_12678_end
  jmp __label_12740_clipsolid
__if_12678_end:
__if_12682_start:
  mov R1, [global_backsector]
  iadd R1, 1
  ...
  mov R1, [R2]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_12690
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_12690:
  jf R0, __if_12682_end
  jmp __label_12740_clipsolid
__if_12682_end:
__if_12695_start:
  mov R1, [global_backsector]
  ...
  mov R1, [R2]
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_12703
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  mov R2, [R3]
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_12703:
  jf R0, __if_12695_end
  jmp __label_12733_clippass
__if_12695_end:
__if_12708_start:
  mov R1, [global_backsector]
  iadd R1, 3
...
__LogicalAnd_ShortCircuit_12722:
  jf R0, __LogicalAnd_ShortCircuit_12729
  mov R3, [global_curline]
  iadd R3, 4
  mov R2, [R3]
  iadd R2, 4
  ...
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_12729:
  jf R0, __if_12708_end
  jmp __function_R_AddLine_return
__if_12708_end:
__label_12733_clippass:
  mov R1, [BP-1]
  mov [SP], R1
  mov R1, [BP-2]
  isub R1, 1
...
__if_13075_end:
  ...
  mov [BP-12], R0
__while_13086_start:
__while_13086_continue:
  mov R1, [BP-12]
  iadd R1, 1
  mov R0, [R1]
  mov R1, [BP-14]
  ilt R0, R1
  jf R0, __while_13086_end
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 2
  mov [BP-12], R1
  jmp __while_13086_start
__while_13086_end:
__if_13093_start:
  mov R0, [BP-13]
  mov R2, [BP-12]
  mov R1, [R2]
  ige R0, R1
  jf R0, __LogicalAnd_ShortCircuit_13099
  mov R1, [BP-14]
  mov R3, [BP-12]
  iadd R3, 1
  mov R2, [R3]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13099:
...
__if_13153_start:
  ...
  mov R1, [global_viewz]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_13160
  mov R2, [global_frontsector]
  iadd R2, 3
  mov R1, [R2]
  ieq R1, 53
  or R0, R1
__LogicalOr_ShortCircuit_13160:
  jf R0, __if_13153_else
  mov R3, [global_frontsector]
  iadd R3, 1
  mov R2, [R3]
  mov [SP], R2
...
__while_13177_start:
__while_13177_continue:
  mov R0, [BP-1]
  igt R0, 0
  jf R0, __while_13177_end
  mov R1, [BP-2]
  mov [SP], R1
...
__if_13307_start:
  ...
  jmp __for_13297_end
__if_13307_end:
__for_13297_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_13297_start
__for_13297_end:
  mov R0, 1
  mov [BP-2], R0
  mov R0, 0
  ...
  mov [BP-6], R0
__while_13362_start:
__while_13362_continue:
  mov R0, 1
  jf R0, __while_13362_end
  mov R1, 0
  mov [SP], R1
...
__if_13617_start:
  mov R0, [BP-3]
  jf R0, __if_13617_else
  mov R1, 550
  mov [SP], R1
  mov R1, 320
  mov [SP+1], R1
  mov R1, __literal_string_13622
  mov [SP+2], R1
  call __function_print_at
  jmp __if_13617_end
__if_13617_else:
...
__literal_string_13541:
  string "X"
__literal_string_13551:
  string "Y"
__literal_string_13561:
  string "SEC"
__literal_string_13572:
  string "FRAME"
__literal_string_13580:
  string "SEGS"
__literal_string_13588:
  string "COLS"
__literal_string_13596:
  string "DRAWS"
__literal_string_13604:
  string "VS"
__literal_string_13612:
  string "SLOW"
__literal_string_13622:
  string "LO"
__literal_string_13626:
  string "HI"
