...
__if_6221_end:
  ...
  mov [BP-12], R0
__while_6235_start:
__while_6235_continue:
  mov R0, [BP-11]
  mov R1, [BP+5]
  mov R2, [BP-8]
  iadd R1, R2
  ilt R0, R1
  jf R0, __while_6235_end
  mov R0, [BP-10]
  mov R1, [BP-2]
  imod R0, R1
  mov [BP-13], R0
...
__if_6347_start:
  mov R0, [BP-19]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_6352
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_6352:
  jf R0, __if_6347_end
  mov R0, [global_perf_draws]
  mov R1, R0
  iadd R1, 1
...
__if_6438_start:
  ...
  ige R0, R1
  jf R0, __if_6438_end
  jmp __while_6235_end
__if_6438_end:
  jmp __while_6235_start
__while_6235_end:
...
__if_6451_start:
  mov R0, [BP+4]
  ile R0, 0
  jt R0, __LogicalOr_ShortCircuit_6456
  mov R1, [BP+5]
  ile R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_6456:
  jf R0, __if_6451_end
...
__if_6988_start:
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_6994
  mov R1, [BP+3]
  mov R3, [BP-1]
  iadd R3, 1
  mov R2, [R3]
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_6994:
  jf R0, __LogicalAnd_ShortCircuit_6999
  mov R1, [BP+4]
  mov R3, [BP-1]
  iadd R3, 2
  mov R2, [R3]
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_6999:
  jf R0, __if_6988_end
  mov R0, [BP-1]
...
__function_R_MakeSpans:
  ...
  isub SP, 5
__while_7278_start:
__while_7278_continue:
  mov R0, [BP+3]
  mov R1, [BP+5]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7283
  mov R1, [BP+3]
  mov R2, [BP+4]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7283:
  jf R0, __while_7278_end
  ...
  iadd R1, 1
  mov [BP+3], R1
  jmp __while_7278_start
__while_7278_end:
__while_7307_start:
__while_7307_continue:
  mov R0, [BP+4]
  mov R1, [BP+6]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7312
  mov R1, [BP+4]
  mov R2, [BP+3]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7312:
  jf R0, __while_7307_end
  mov R1, global_spanstart
  mov R2, [BP+4]
  iadd R1, R2
  mov R1, [R1]
  ...
  isub R1, 1
  mov [BP+4], R1
  jmp __while_7307_start
__while_7307_end:
__while_7336_start:
__while_7336_continue:
  mov R0, [BP+5]
  mov R1, [BP+3]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7341
  mov R1, [BP+5]
  mov R2, [BP+6]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7341:
  jf R0, __while_7336_end
  mov R0, [BP+2]
  mov R1, global_spanstart
  mov R2, [BP+5]
  iadd R1, R2
  ...
  iadd R1, 1
  mov [BP+5], R1
  jmp __while_7336_start
__while_7336_end:
__while_7352_start:
__while_7352_continue:
  mov R0, [BP+6]
  mov R1, [BP+4]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7357
  mov R1, [BP+6]
  mov R2, [BP+5]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7357:
  jf R0, __while_7352_end
  mov R0, [BP+2]
  mov R1, global_spanstart
  mov R2, [BP+6]
  iadd R1, R2
...
__if_7442_start:
  mov R0, [BP-6]
  ine R0, 255
  jf R0, __LogicalAnd_ShortCircuit_7447
  mov R1, [BP-6]
  mov R2, [BP-7]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7447:
  jf R0, __if_7442_end
...
__if_8230_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8242
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_8242:
  jf R0, __if_8230_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_8509_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8521
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_8521:
  jf R0, __if_8509_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_8806_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8818
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_8818:
  jf R0, __if_8806_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_9382_start:
  ...
  mov R0, [R1]
  ieq R0, 53
  jf R0, __LogicalAnd_ShortCircuit_9389
  mov R2, [global_backsector]
  iadd R2, 3
  mov R1, [R2]
  ieq R1, 53
  and R0, R1
__LogicalAnd_ShortCircuit_9389:
  jf R0, __if_9382_end
  mov R1, [global_backsector]
  iadd R1, 1
  mov R0, [R1]
...
__if_9433_start:
  ...
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_9439
  mov R2, [global_backsector]
  iadd R2, 3
  mov R1, [R2]
  mov R3, [global_frontsector]
...
__if_9455_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_9463
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  iadd R3, 1
...
__if_9877_start:
  mov R0, [global_markceiling]
  jf R0, __LogicalAnd_ShortCircuit_9879
  mov R1, [global_ceilingplane]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_9879:
  jf R0, __if_9877_else
...
__if_9912_start:
  ...
  and R0, 2
  cib R0
  jt R0, __LogicalOr_ShortCircuit_9919
  mov R1, [global_maskedtexture]
  or R0, R1
__LogicalOr_ShortCircuit_9919:
  jf R0, __LogicalAnd_ShortCircuit_9921
  mov R2, [BP-7]
  iadd R2, 9
  mov R1, [R2]
  ieq R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_9921:
  jf R0, __if_9912_end
__if_9927_start:
  mov R0, [global_opening_used]
  mov R1, [global_rw_stopx]
...
__if_9983_start:
  ...
  and R0, 1
  cib R0
  jt R0, __LogicalOr_ShortCircuit_9990
  mov R1, [global_maskedtexture]
  or R0, R1
__LogicalOr_ShortCircuit_9990:
  jf R0, __LogicalAnd_ShortCircuit_9992
  mov R2, [BP-7]
  iadd R2, 10
  mov R1, [R2]
  ieq R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_9992:
  jf R0, __if_9983_end
__if_9998_start:
  mov R0, [global_opening_used]
  mov R1, [global_rw_stopx]
...
__for_10013_start:
  ...
  iadd R1, R2
  mov [R1], R0
__for_10013_continue:
  mov R0, [BP-8]
  mov R1, R0
  iadd R1, 1
  mov [BP-8], R1
  jmp __for_10013_start
__for_10013_end:
  mov R0, global_openings
  mov R1, [global_opening_used]
  mov R2, [BP+2]
...
__if_10054_start:
  mov R0, [global_maskedtexture]
  jf R0, __LogicalAnd_ShortCircuit_10056
  mov R2, [BP-7]
  iadd R2, 6
  mov R1, [R2]
  and R1, 2
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_10056:
...
__if_10072_start:
  mov R0, [global_maskedtexture]
  jf R0, __LogicalAnd_ShortCircuit_10074
  mov R2, [BP-7]
  iadd R2, 6
  mov R1, [R2]
  and R1, 1
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_10074:
...
__if_10364_start:
  mov R0, [BP-8]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_10369
  mov R1, [BP-17]
  mov R2, [BP-8]
  mov R3, [BP-5]
  iadd R2, R3
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_10369:
...
__if_10282_end:
  ...
  iadd R0, R1
  mov [BP-3], R0
__for_10272_continue:
  mov R0, [BP-5]
  mov R1, R0
  iadd R1, 1
  mov [BP-5], R1
  jmp __for_10272_start
__for_10272_end:
...
__if_10559_start:
  mov R0, [BP-3]
  bnot R0
  jf R0, __if_10559_end
__if_10563_start:
  mov R0, [BP+2]
  mov R1, [BP-1]
  ile R0, R1
  jf R0, __if_10563_end
  mov R0, [BP-4]
  igt R0, 0
...
__for_11098_start:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __for_11098_end
  mov R1, [BP-1]
  mov [SP], R1
  call __function_R_ProjectSprite
__for_11098_continue:
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
  mov [BP-1], R0
  jmp __for_11098_start
__for_11098_end:
...
__if_11171_start:
  ...
  mov [BP-3], R0
__if_11171_end:
__for_11159_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_11159_start
__for_11159_end:
  ...
  iadd R1, R2
  mov [R1], R0
__for_11136_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_11136_start
__for_11136_end:
...
__if_11319_start:
  mov R0, [BP-13]
  ige R0, 0
  jf R0, __LogicalAnd_ShortCircuit_11324
  mov R1, [BP-13]
  mov R2, [BP-5]
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_11324:
  jf R0, __if_11319_end
  mov R0, [BP-9]
  iadd R0, 65536
  isub R0, 1
  shl R0, -16
...
__if_11319_end:
  ...
  iadd R0, R1
  mov [BP-7], R0
__for_11283_continue:
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 1
  mov [BP-12], R1
  jmp __for_11283_start
__for_11283_end:
...
__if_11518_start:
  ...
  mov R1, [R2]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_11526
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [BP+2]
  ...
  ilt R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_11526:
  jt R0, __LogicalOr_ShortCircuit_11539
  mov R2, [BP-1]
  iadd R2, 6
  mov R1, [R2]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_11534
  mov R3, [BP-1]
  iadd R3, 11
  mov R2, [R3]
  ieq R2, -1
  and R1, R2
__LogicalAnd_ShortCircuit_11534:
  or R0, R1
__LogicalOr_ShortCircuit_11539:
  jf R0, __if_11518_end
  jmp __for_11500_continue
__if_11518_end:
__if_11541_start:
  mov R1, [BP-1]
  iadd R1, 1
...
__if_11593_start:
  ...
  mov R2, [R3]
  ilt R1, R2
  jt R1, __LogicalOr_ShortCircuit_11612
  mov R2, [BP-7]
  mov R4, [BP+2]
  iadd R4, 7
  mov R3, [R4]
  ilt R2, R3
  jf R2, __LogicalAnd_ShortCircuit_11611
  mov R5, [BP+2]
  iadd R5, 2
  mov R4, [R5]
  mov [SP], R4
  ...
  bnot R3
  and R2, R3
__LogicalAnd_ShortCircuit_11611:
  or R1, R2
__LogicalOr_ShortCircuit_11612:
  mov R0, R1
  jf R0, __if_11593_end
__if_11614_start:
  mov R1, [BP-1]
  iadd R1, 11
  mov R0, [R1]
  ine R0, -1
  jf R0, __if_11614_end
  mov R1, [BP-1]
  mov [SP], R1
  mov R1, [BP-4]
  mov [SP+1], R1
...
__if_11689_start:
  ...
  mov [R1], R0
__if_11689_end:
__for_11680_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_11680_start
__for_11680_end:
  jmp __if_11675_end
__if_11675_else:
__if_11704_start:
...
__if_11734_start:
  ...
  mov [R1], R0
__if_11734_end:
__for_11709_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_11709_start
__for_11709_end:
__if_11704_end:
__if_11675_end:
__if_11646_end:
__for_11500_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_11500_start
__for_11500_end:
  mov R1, [BP+2]
  mov R0, [R1]
  mov [BP-3], R0
...
__if_11773_start:
  ...
  mov [R1], R0
__if_11773_end:
__for_11749_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_11749_start
__for_11749_end:
  mov R0, global_spr_clipbot
  mov [global_mfloorclip], R0
  mov R0, global_spr_cliptop
...
__if_12151_end:
__for_12141_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12141_start
__for_12141_end:
...
__if_12208_start:
  ...
  call __function_R_RenderMaskedSegRange
__if_12208_end:
__for_12190_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_12190_start
__for_12190_end:
...
__while_12241_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_12241_end
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 2
  mov [BP-2], R1
  jmp __while_12241_start
__while_12241_end:
__if_12250_start:
  mov R0, [BP+2]
  mov R2, [BP-2]
...
__while_12272_start:
__while_12272_continue:
  mov R0, [BP-1]
  mov R1, [BP-2]
  ine R0, R1
  jf R0, __while_12272_end
  lea R13, [BP-1]
  mov R13, [R13]
  mov R12, [BP-1]
  isub R12, 2
...
__if_12340_start:
  ...
  iadd R1, 1
  mov [R1], R0
  jmp __label_12362_crunch
__if_12340_end:
  jmp __while_12315_start
__while_12315_end:
  mov R2, [BP-1]
  iadd R2, 1
  mov R1, [R2]
  ...
  iadd R1, 1
  mov [R1], R0
__label_12362_crunch:
__if_12363_start:
  mov R0, [BP-1]
  mov R1, [BP-2]
  ieq R0, R1
  jf R0, __if_12363_end
  jmp __function_R_ClipSolidWallSegment_return
__if_12363_end:
__while_12368_start:
__while_12368_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 2
  mov [BP-1], R1
...
__while_12394_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_12394_end
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 2
  mov [BP-1], R1
  jmp __while_12394_start
__while_12394_end:
__if_12403_start:
  mov R0, [BP+2]
  mov R2, [BP-1]
...
__if_12685_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_12693
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_12693:
...
__if_12698_start:
  ...
  mov R1, [R2]
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_12706
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  mov R2, [R3]
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_12706:
  jf R0, __if_12698_end
  jmp __label_12736_clippass
__if_12698_end:
__if_12711_start:
  mov R1, [global_backsector]
  iadd R1, 3
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_12719
  mov R2, [global_backsector]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_12719:
  jf R0, __LogicalAnd_ShortCircuit_12725
  mov R2, [global_backsector]
  iadd R2, 4
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_12725:
  jf R0, __LogicalAnd_ShortCircuit_12732
  mov R3, [global_curline]
  iadd R3, 4
  mov R2, [R3]
  iadd R2, 4
  ...
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_12732:
  jf R0, __if_12711_end
  jmp __function_R_AddLine_return
__if_12711_end:
__label_12736_clippass:
  mov R1, [BP-1]
  mov [SP], R1
  mov R1, [BP-2]
  isub R1, 1
...
__if_13078_end:
  ...
  mov [BP-12], R0
__while_13089_start:
__while_13089_continue:
  mov R1, [BP-12]
  iadd R1, 1
  mov R0, [R1]
  mov R1, [BP-14]
  ilt R0, R1
  jf R0, __while_13089_end
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 2
  mov [BP-12], R1
  jmp __while_13089_start
__while_13089_end:
__if_13096_start:
  mov R0, [BP-13]
  mov R2, [BP-12]
  mov R1, [R2]
  ige R0, R1
  jf R0, __LogicalAnd_ShortCircuit_13102
  mov R1, [BP-14]
  mov R3, [BP-12]
  iadd R3, 1
  mov R2, [R3]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13102:
  jf R0, __if_13096_end
  mov R0, 0
  jmp __function_R_CheckBBox_return
__if_13096_end:
  mov R0, 1
...
__if_13156_start:
  ...
  mov R1, [global_viewz]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_13163
  mov R2, [global_frontsector]
  iadd R2, 3
  mov R1, [R2]
  ieq R1, 53
  or R0, R1
__LogicalOr_ShortCircuit_13163:
  jf R0, __if_13156_else
  mov R3, [global_frontsector]
  iadd R3, 1
  mov R2, [R3]
  mov [SP], R2
...
__while_13180_start:
__while_13180_continue:
  mov R0, [BP-1]
  igt R0, 0
  jf R0, __while_13180_end
  mov R1, [BP-2]
  mov [SP], R1
...
__if_13310_start:
  ...
  jmp __for_13300_end
__if_13310_end:
__for_13300_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_13300_start
__for_13300_end:
  mov R0, 1
  mov [BP-2], R0
  mov R0, 0
  ...
  mov [BP-6], R0
__while_13365_start:
__while_13365_continue:
  mov R0, 1
  jf R0, __while_13365_end
  mov R1, 0
  mov [SP], R1
...
__if_13620_start:
  mov R0, [BP-3]
  jf R0, __if_13620_else
  mov R1, 550
  mov [SP], R1
  mov R1, 320
  mov [SP+1], R1
  mov R1, __literal_string_13625
  mov [SP+2], R1
  call __function_print_at
  jmp __if_13620_end
__if_13620_else:
...
__literal_string_13544:
  string "X"
__literal_string_13554:
  string "Y"
__literal_string_13564:
  string "SEC"
__literal_string_13575:
  string "FRAME"
__literal_string_13583:
  string "SEGS"
__literal_string_13591:
  string "COLS"
__literal_string_13599:
  string "DRAWS"
__literal_string_13607:
  string "VS"
__literal_string_13615:
  string "SLOW"
__literal_string_13625:
  string "LO"
__literal_string_13629:
  string "HI"
