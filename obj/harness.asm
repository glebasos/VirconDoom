...
; location of global variables
  ...
  %define global_mobj_actions 1704703
  %define global_pspr_actions 1704778
  %define global_gameexit 1704853
  %define global_secretexit 1704854
  %define global_totalkills 1704855
  %define global_totalitems 1704856
  %define global_totalsecret 1704857
  %define global_thinkercap 1704858
  %define global_leveltime 1704862
  %define global_vissprites 1704863
  %define global_visspr_count 1705695
  %define global_visspr_order 1705696
  %define global_spr_sectorlight 1705760
  %define global_perf_sprites 1705761
  %define global_spr_cliptop 1705762
  %define global_spr_clipbot 1706082
  %define global_mfloorclip 1706402
  %define global_mceilingclip 1706403
  %define global_newend 1706404
  %define global_solidsegs 1706405
  %define global_checkcoord 1706469
  %define global_opentop 1706517
  %define global_openbottom 1706518
  %define global_openrange 1706519
  %define global_lowfloor 1706520
  %define global_trace 1706521
  %define global_intercepts 1706525
  %define global_intercept_n 1707037
  %define global_earlyout 1707038
  %define global_sightzstart 1707039
  %define global_s_topslope 1707040
  %define global_s_bottomslope 1707041
  %define global_strace 1707042
  %define global_st2x 1707046
  %define global_st2y 1707047
  %define global_AllPassed 1707048
  %define global_checkNum 1707049
  %define global_firstFail 1707050
  %define global_diagExpected 1707051
  %define global_diagActual 1707052
...
__if_11346_start:
  mov R0, [BP-3]
  bnot R0
  jf R0, __if_11346_end
__if_11350_start:
  mov R0, [BP+2]
  mov R1, [BP-1]
  ile R0, R1
  jf R0, __if_11350_end
  mov R0, [BP-4]
  igt R0, 0
...
__for_11885_start:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __for_11885_end
  mov R1, [BP-1]
  mov [SP], R1
  call __function_R_ProjectSprite
__for_11885_continue:
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
  mov [BP-1], R0
  jmp __for_11885_start
__for_11885_end:
...
__for_11909_start:
  ...
  mov R1, [global_visspr_count]
  ilt R0, R1
  jf R0, __for_11909_end
  mov R0, [BP-1]
  mov R1, global_visspr_order
  mov R2, [BP-1]
  iadd R1, R2
  mov [R1], R0
__for_11909_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_11909_start
__for_11909_end:
  mov R0, 0
  mov [BP-1], R0
__for_11923_start:
...
__for_11946_end:
  ...
  iadd R1, R2
  mov [R1], R0
__for_11923_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_11923_start
__for_11923_end:
...
__if_12106_start:
  mov R0, [BP-13]
  ige R0, 0
  jf R0, __LogicalAnd_ShortCircuit_12111
  mov R1, [BP-13]
  mov R2, [BP-5]
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_12111:
  jf R0, __if_12106_end
  mov R0, [BP-9]
  iadd R0, 65536
  isub R0, 1
  shl R0, -16
...
__if_12106_end:
  ...
  iadd R0, R1
  mov [BP-7], R0
__for_12070_continue:
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 1
  mov [BP-12], R1
  jmp __for_12070_start
__for_12070_end:
...
__if_12305_start:
  ...
  mov R1, [R2]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_12313
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [BP+2]
  ...
  ilt R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_12313:
  jt R0, __LogicalOr_ShortCircuit_12326
  mov R2, [BP-1]
  iadd R2, 6
  mov R1, [R2]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_12321
  mov R3, [BP-1]
  iadd R3, 11
  mov R2, [R3]
  ieq R2, -1
  and R1, R2
__LogicalAnd_ShortCircuit_12321:
  or R0, R1
__LogicalOr_ShortCircuit_12326:
  jf R0, __if_12305_end
  jmp __for_12287_continue
__if_12305_end:
__if_12328_start:
  mov R1, [BP-1]
  iadd R1, 1
...
__if_12380_start:
  ...
  mov R2, [R3]
  ilt R1, R2
  jt R1, __LogicalOr_ShortCircuit_12399
  mov R2, [BP-7]
  mov R4, [BP+2]
  iadd R4, 7
  mov R3, [R4]
  ilt R2, R3
  jf R2, __LogicalAnd_ShortCircuit_12398
  mov R5, [BP+2]
  iadd R5, 2
  mov R4, [R5]
  mov [SP], R4
  ...
  bnot R3
  and R2, R3
__LogicalAnd_ShortCircuit_12398:
  or R1, R2
__LogicalOr_ShortCircuit_12399:
  mov R0, R1
  jf R0, __if_12380_end
__if_12401_start:
  mov R1, [BP-1]
  iadd R1, 11
  mov R0, [R1]
...
__if_12447_start:
  ...
  mov [R1], R0
__if_12447_end:
__for_12438_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12438_start
__for_12438_end:
  jmp __if_12433_end
__if_12433_else:
__if_12462_start:
...
__if_12476_start:
  ...
  mov [R1], R0
__if_12476_end:
__for_12467_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12467_start
__for_12467_end:
  jmp __if_12462_end
__if_12462_else:
__if_12491_start:
...
__if_12521_start:
  ...
  mov [R1], R0
__if_12521_end:
__for_12496_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12496_start
__for_12496_end:
__if_12491_end:
__if_12462_end:
__if_12433_end:
__for_12287_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_12287_start
__for_12287_end:
  mov R1, [BP+2]
  mov R0, [R1]
  mov [BP-3], R0
...
__if_12560_start:
  ...
  mov [R1], R0
__if_12560_end:
__for_12536_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12536_start
__for_12536_end:
  mov R0, global_spr_clipbot
  mov [global_mfloorclip], R0
  mov R0, global_spr_cliptop
...
__if_12938_end:
__for_12928_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12928_start
__for_12928_end:
...
__for_12961_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12961_start
__for_12961_end:
  mov R0, [global_ds_count]
  isub R0, 1
  mov [BP-2], R0
...
__if_12995_start:
  ...
  call __function_R_RenderMaskedSegRange
__if_12995_end:
__for_12977_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_12977_start
__for_12977_end:
...
__while_13028_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_13028_end
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 2
  mov [BP-2], R1
  jmp __while_13028_start
__while_13028_end:
__if_13037_start:
  mov R0, [BP+2]
  mov R2, [BP-2]
...
__if_13127_start:
  ...
  iadd R1, 1
  mov [R1], R0
  jmp __label_13149_crunch
__if_13127_end:
  jmp __while_13102_start
__while_13102_end:
  mov R2, [BP-1]
  iadd R2, 1
  mov R1, [R2]
...
__while_13181_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_13181_end
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 2
  mov [BP-1], R1
  jmp __while_13181_start
__while_13181_end:
__if_13190_start:
  mov R0, [BP+2]
  mov R2, [BP-1]
...
__if_13214_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jf R0, __if_13214_end
  jmp __function_R_ClipPassWallSegment_return
__if_13214_end:
__while_13220_start:
__while_13220_continue:
  mov R0, [BP+3]
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
...
__if_13468_start:
  ...
  ine R0, -1
  bnot R0
  jf R0, __if_13468_end
  jmp __label_13530_clipsolid
__if_13468_end:
__if_13472_start:
  mov R1, [global_backsector]
  iadd R1, 1
  ...
  mov R1, [R2]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_13480
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_13480:
  jf R0, __if_13472_end
  jmp __label_13530_clipsolid
__if_13472_end:
__if_13485_start:
  mov R1, [global_backsector]
  ...
  mov R1, [R2]
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_13493
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  mov R2, [R3]
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_13493:
  jf R0, __if_13485_end
  jmp __label_13523_clippass
__if_13485_end:
__if_13498_start:
  mov R1, [global_backsector]
  iadd R1, 3
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_13506
  mov R2, [global_backsector]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13506:
  jf R0, __LogicalAnd_ShortCircuit_13512
  mov R2, [global_backsector]
  iadd R2, 4
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13512:
  jf R0, __LogicalAnd_ShortCircuit_13519
  mov R3, [global_curline]
  iadd R3, 4
  mov R2, [R3]
  iadd R2, 4
  ...
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_13519:
  jf R0, __if_13498_end
  jmp __function_R_AddLine_return
__if_13498_end:
__label_13523_clippass:
  mov R1, [BP-1]
  mov [SP], R1
  mov R1, [BP-2]
  isub R1, 1
...
__if_13865_end:
  ...
  mov [BP-12], R0
__while_13876_start:
__while_13876_continue:
  mov R1, [BP-12]
  iadd R1, 1
  mov R0, [R1]
  mov R1, [BP-14]
  ilt R0, R1
  jf R0, __while_13876_end
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 2
  mov [BP-12], R1
  jmp __while_13876_start
__while_13876_end:
__if_13883_start:
  mov R0, [BP-13]
  mov R2, [BP-12]
...
__while_13967_start:
__while_13967_continue:
  mov R0, [BP-1]
  igt R0, 0
  jf R0, __while_13967_end
  mov R1, [BP-2]
  mov [SP], R1
...
__if_13984_start:
  ...
  and R0, 32768
  cib R0
  jf R0, __if_13984_end
__if_13989_start:
  mov R0, [BP+2]
  ieq R0, -1
  jf R0, __if_13989_else
  mov R1, 0
  mov [SP], R1
...
__if_15199_start:
  mov R0, [BP+2]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_15204
  mov R1, [BP+3]
  ilt R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_15204:
  jt R0, __LogicalOr_ShortCircuit_15208
  mov R1, [BP+2]
  mov R2, [global_bmapwidth]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15208:
  jt R0, __LogicalOr_ShortCircuit_15212
  mov R1, [BP+3]
  mov R2, [global_bmapheight]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15212:
  jf R0, __if_15199_end
  mov R0, 1
...
__if_15258_start:
  ...
  bnot R1
  mov R0, R1
  jf R0, __if_15258_end
  mov R0, 0
  jmp __function_P_BlockLinesIterator_return
__if_15258_end:
__for_15232_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_15232_start
__for_15232_end:
  mov R0, 1
...
__if_15273_start:
  mov R0, [BP+2]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_15278
  mov R1, [BP+3]
  ilt R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_15278:
  jt R0, __LogicalOr_ShortCircuit_15282
  mov R1, [BP+2]
  mov R2, [global_bmapwidth]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15282:
  jt R0, __LogicalOr_ShortCircuit_15286
  mov R1, [BP+3]
  mov R2, [global_bmapheight]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15286:
  jf R0, __if_15273_end
  mov R0, 1
...
__if_15308_start:
  ...
  bnot R1
  mov R0, R1
  jf R0, __if_15308_end
  mov R0, 0
  jmp __function_P_BlockThingsIterator_return
__if_15308_end:
__for_15291_continue:
  mov R1, [BP-1]
  iadd R1, 9
  mov R0, [R1]
  mov [BP-1], R0
  jmp __for_15291_start
__for_15291_end:
  mov R0, 1
...
__if_15338_start:
  mov R0, [1706523]
  igt R0, 1048576
  jt R0, __LogicalOr_ShortCircuit_15347
  mov R1, [1706524]
  igt R1, 1048576
  or R0, R1
__LogicalOr_ShortCircuit_15347:
  jt R0, __LogicalOr_ShortCircuit_15354
  mov R1, [1706523]
  ilt R1, -1048576
  or R0, R1
__LogicalOr_ShortCircuit_15354:
  jt R0, __LogicalOr_ShortCircuit_15362
  mov R1, [1706524]
  ilt R1, -1048576
  or R0, R1
__LogicalOr_ShortCircuit_15362:
  jf R0, __if_15338_else
  mov R4, [BP+2]
  mov R3, [R4]
  mov R2, [R3]
  mov [SP], R2
...
__if_15431_start:
  mov R0, [BP-3]
  ilt R0, 0
  jf R0, __if_15431_end
  mov R0, 1
  jmp __function_PIT_AddLineIntercepts_return
__if_15431_end:
__if_15437_start:
  mov R0, [global_earlyout]
  jf R0, __LogicalAnd_ShortCircuit_15439
  mov R1, [BP-3]
  ilt R1, 65536
  and R0, R1
__LogicalAnd_ShortCircuit_15439:
  jf R0, __LogicalAnd_ShortCircuit_15446
  mov R2, [BP+2]
  iadd R2, 16
  mov R1, [R2]
  ine R1, -1
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_15446:
...
__function_P_TraverseIntercepts:
  ...
  mov [BP-1], R0
__while_15673_start:
__while_15673_continue:
  mov R0, [BP-1]
  mov R1, R0
  isub R1, 1
  mov [BP-1], R1
  cib R0
  jf R0, __while_15673_end
  mov R0, 2147483647
  mov [BP-2], R0
  mov R0, 0
  mov [BP-3], R0
...
__if_15690_start:
  ...
  mov [BP-4], R0
__if_15690_end:
__for_15680_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_15680_start
__for_15680_end:
__if_15710_start:
  mov R0, [BP-2]
  mov R1, [BP+3]
  igt R0, R1
  jf R0, __if_15710_end
  mov R0, 1
...
__if_16858_start:
  ...
  mov R1, [global_validcount]
  ieq R0, R1
  jf R0, __if_16858_end
  jmp __for_16835_continue
__if_16858_end:
  mov R0, [global_validcount]
  mov R1, [BP-2]
  iadd R1, 14
...
__if_16963_start:
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_16971
  mov R2, [BP-7]
  iadd R2, 1
  mov R1, [R2]
  mov R3, [BP-8]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_16971:
  jf R0, __if_16963_end
  jmp __for_16835_continue
__if_16963_end:
__if_16976_start:
  mov R1, [BP-7]
...
__if_17059_start:
  ...
  mov R1, [global_s_bottomslope]
  ile R0, R1
  jf R0, __if_17059_end
  mov R0, 0
  jmp __function_P_CrossSubsector_return
__if_17059_end:
__for_16835_continue:
  mov R0, [BP-19]
  mov R1, R0
  iadd R1, 1
  mov [BP-19], R1
  jmp __for_16835_start
__for_16835_end:
  mov R0, 1
...
__if_17073_start:
  ...
  and R0, 32768
  cib R0
  jf R0, __if_17073_end
__if_17078_start:
  mov R0, [BP+2]
  ieq R0, -1
  jf R0, __if_17078_end
  mov R1, 0
  mov [SP], R1
...
__if_17292_start:
  mov R0, [BP+2]
  bnot R0
  jf R0, __if_17292_end
  mov R0, 0
  mov [global_AllPassed], R0
__if_17299_start:
  mov R0, [global_firstFail]
  ieq R0, 0
  jf R0, __if_17299_end
  mov R0, [global_checkNum]
  mov [global_firstFail], R0
__if_17299_end:
__if_17292_end:
...
__if_17311_start:
  ...
  mov R1, [BP+3]
  ine R0, R1
  jf R0, __if_17311_end
  mov R0, 0
  mov [global_AllPassed], R0
__if_17319_start:
  mov R0, [global_firstFail]
  ieq R0, 0
  jf R0, __if_17319_end
  mov R0, [global_checkNum]
  mov [global_firstFail], R0
  mov R0, [BP+3]
  mov [global_diagExpected], R0
...
__for_17351_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17351_start
__for_17351_end:
  mov R0, 0
  mov [BP-1], R0
__for_17371_start:
...
__for_17371_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17371_start
__for_17371_end:
  mov R0, 0
  mov [BP-1], R0
__for_17431_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17431_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17431_start
__for_17431_end:
  mov R0, 0
  mov [BP-1], R0
__for_17449_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17449_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17449_start
__for_17449_end:
  mov R0, 0
  mov [BP-1], R0
__for_17467_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17467_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17467_start
__for_17467_end:
  ...
  mov R1, [BP-4]
  igt R1, 65520
  jf R1, __LogicalAnd_ShortCircuit_17533
  mov R2, [BP-4]
  ilt R2, 65552
  and R1, R2
__LogicalAnd_ShortCircuit_17533:
  mov [SP], R1
  call __function_Check
  mov R0, -1073741824
  mov [BP-5], R0
...
__LogicalAnd_ShortCircuit_17612:
  ...
  mov R1, [BP-8]
  ieq R1, -50
  jf R1, __LogicalAnd_ShortCircuit_17634
  mov R2, [BP-7]
  ieq R2, 0x80000000
  and R1, R2
__LogicalAnd_ShortCircuit_17634:
  mov [SP], R1
  call __function_Check
  lea R1, [BP-10]
  mov [SP], R1
  ...
  mov R1, [BP-7]
  ieq R1, 150
  jf R1, __LogicalAnd_ShortCircuit_17650
  mov R2, [BP-9]
  ieq R2, 100
  and R1, R2
__LogicalAnd_ShortCircuit_17650:
  jf R1, __LogicalAnd_ShortCircuit_17656
  mov R2, [BP-10]
  ieq R2, 300
  and R1, R2
__LogicalAnd_ShortCircuit_17656:
  mov [SP], R1
  call __function_Check
  ...
  mov R1, [R1]
  ieq R1, 0
  jf R1, __LogicalAnd_ShortCircuit_17708
  mov R2, [BP-15]
  iadd R2, 199
  mov R2, [R2]
  ieq R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_17708:
  mov [SP], R1
  call __function_Check
  mov R1, 50
  mov [SP], R1
...
__if_17785_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17798
  mov R1, __embedded_gen_segs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 467
  or R0, R1
__LogicalOr_ShortCircuit_17798:
  jf R0, __if_17785_end
  mov R0, 0
  mov [BP-16], R0
__if_17785_end:
__if_17804_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17817
  mov R1, __embedded_gen_segs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 467
  or R0, R1
__LogicalOr_ShortCircuit_17817:
  jf R0, __if_17804_end
  mov R0, 0
  mov [BP-16], R0
__if_17804_end:
__if_17823_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17836
  mov R1, __embedded_gen_segs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 475
  or R0, R1
__LogicalOr_ShortCircuit_17836:
  jf R0, __if_17823_end
  mov R0, 0
  mov [BP-16], R0
__if_17823_end:
__for_17775_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17775_start
__for_17775_end:
  mov R1, [BP-16]
  mov [SP], R1
  call __function_Check
...
__if_17876_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17889
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17889:
  jf R0, __if_17876_end
  mov R0, 0
  mov [BP-17], R0
__if_17876_end:
__if_17895_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17908
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17908:
  jf R0, __if_17895_end
  mov R0, 0
  mov [BP-17], R0
__if_17895_end:
__if_17914_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17927
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17927:
  jf R0, __if_17914_end
  mov R0, 0
  mov [BP-17], R0
__if_17914_end:
__for_17847_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17847_start
__for_17847_end:
  mov R1, [BP-17]
  mov [SP], R1
  call __function_Check
...
__for_18217_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_18217_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18217_start
__for_18217_end:
...
__if_18275_start:
  ...
  mov [BP-18], R0
__if_18275_end:
__for_18266_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18266_start
__for_18266_end:
  mov R1, [BP-18]
  mov [SP], R1
  call __function_Check
...
__if_18302_start:
  ...
  mov [BP-20], R0
__if_18302_end:
__for_18293_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18293_start
__for_18293_end:
  mov R1, [BP-19]
  ine R1, 0
  jt R1, __LogicalOr_ShortCircuit_18334
  mov R2, [BP-20]
  ine R2, 0
  or R1, R2
__LogicalOr_ShortCircuit_18334:
  mov [SP], R1
  call __function_Check
  mov R1, [BP-19]
  mov [SP], R1
...
__for_18368_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_18368_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18368_start
__for_18368_end:
  mov R1, __embedded_gen_states
  iadd R1, 98
  iadd R1, 1
...
__if_18514_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18527
  mov R1, __embedded_gen_states
  mov R2, [BP-1]
  imul R2, 7
  iadd R1, R2
  ...
  ige R1, 967
  or R0, R1
__LogicalOr_ShortCircuit_18527:
  jf R0, __if_18514_end
  mov R0, 0
  mov [BP-22], R0
__if_18514_end:
__if_18533_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18546
  mov R1, __embedded_gen_states
  mov R2, [BP-1]
  imul R2, 7
  iadd R1, R2
  ...
  ige R1, 75
  or R0, R1
__LogicalOr_ShortCircuit_18546:
  jf R0, __if_18533_end
  mov R0, 0
  mov [BP-22], R0
__if_18533_end:
__for_18485_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18485_start
__for_18485_end:
  mov R1, [BP-22]
  mov [SP], R1
  call __function_Check
...
__if_18597_end:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_18554_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18554_start
__for_18554_end:
...
__if_18651_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18660
  mov R1, global_viewangletox
  mov R2, [BP-1]
  iadd R1, R2
  mov R1, [R1]
  ...
  igt R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_18660:
  jf R0, __if_18651_end
  mov R0, 0
  mov [BP-23], R0
__if_18651_end:
__for_18628_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18628_start
__for_18628_end:
  mov R1, [BP-23]
  mov [SP], R1
  call __function_Check
...
__if_18673_end:
  ...
  call __function_Check
__while_18687_start:
__while_18687_continue:
  mov R0, 1
  jf R0, __while_18687_end
__if_18690_start:
  mov R0, [global_AllPassed]
  jf R0, __if_18690_else
  mov R1, -16711936
  mov [SP], R1
...
__literal_string_18698:
  string "VIRCONDOOM CORE ALL GREEN"
__literal_string_18702:
  string "TOTAL CHECKS"
__literal_string_18713:
  string "CORE FAIL - FIRST FAIL CHECK"
__literal_string_18721:
  string "EXPECTED"
__literal_string_18729:
  string "ACTUAL"
__literal_string_18737:
  string "TOTAL CHECKS"
