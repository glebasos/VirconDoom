...
__if_4580_start:
  ...
  mov R0, [R1]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_4583
  mov R2, [BP-3]
  iadd R2, 16
  mov R1, [R2]
  mov R3, [BP-3]
  ...
  ine R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_4583:
  jf R0, __if_4580_end
  mov R3, [BP-3]
  iadd R3, 16
  mov R2, [R3]
...
__if_4654_start:
  ...
  mov R0, [R1]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_4657
  mov R2, [BP-3]
  iadd R2, 16
  mov R1, [R2]
  mov R3, [BP-3]
  ...
  ine R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_4657:
  jf R0, __if_4654_end
  mov R2, [BP-3]
  iadd R2, 16
  mov R1, [R2]
...
__if_5097_start:
  mov R0, [BP+2]
  bnot R0
  jf R0, __LogicalAnd_ShortCircuit_5101
  mov R1, [BP+3]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_5101:
  jf R0, __if_5097_end
  mov R0, 0
...
__if_5202_start:
  ...
  mov R1, [BP+3]
  igt R0, R1
  jf R0, __if_5202_else
__if_5208_start:
  mov R0, [BP+2]
  ilt R0, 512
  jf R0, __if_5208_else
  mov R0, 2048
  mov [BP-1], R0
  jmp __if_5208_end
__if_5208_else:
...
__if_5286_start:
  mov R0, [BP+3]
  ige R0, 0
  jf R0, __if_5286_else
__if_5291_start:
  mov R0, [BP+2]
  mov R1, [BP+3]
  igt R0, R1
  jf R0, __if_5291_else
__if_5297_start:
  mov R0, [BP+2]
  ilt R0, 512
...
__if_6051_end:
  ...
  mov [BP-3], R0
__while_6061_start:
__while_6061_continue:
  mov R0, [BP-3]
  and R0, 32768
  bnot R0
  jf R0, __while_6061_end
  mov R0, [global_nodes]
  mov R1, [BP-3]
  imul R1, 14
  iadd R0, R1
...
__if_6903_start:
  mov R0, [BP-19]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_6908
  mov R1, [global_wallcmd_count]
  ilt R1, 3072
  and R0, R1
__LogicalAnd_ShortCircuit_6908:
  jf R0, __if_6903_end
  mov R0, [global_perf_draws]
  mov R1, R0
  iadd R1, 1
...
__LogicalAnd_ShortCircuit_7249:
  jf R0, __LogicalAnd_ShortCircuit_7254
  mov R1, [BP+4]
  mov R3, [BP-1]
  iadd R3, 2
  mov R2, [R3]
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7254:
  jf R0, __if_7243_end
  mov R0, [BP-1]
...
__function_R_MakeSpans:
  ...
  isub SP, 5
__while_7528_start:
__while_7528_continue:
  mov R0, [BP+3]
  mov R1, [BP+5]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7533
  mov R1, [BP+3]
  mov R2, [BP+4]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7533:
  jf R0, __while_7528_end
  ...
  iadd R1, 1
  mov [BP+3], R1
  jmp __while_7528_start
__while_7528_end:
__while_7557_start:
__while_7557_continue:
  mov R0, [BP+4]
  mov R1, [BP+6]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7562
  mov R1, [BP+4]
  mov R2, [BP+3]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7562:
  jf R0, __while_7557_end
  mov R1, global_spanstart
  mov R2, [BP+4]
  iadd R1, R2
  mov R1, [R1]
  ...
  isub R1, 1
  mov [BP+4], R1
  jmp __while_7557_start
__while_7557_end:
__while_7586_start:
__while_7586_continue:
  mov R0, [BP+5]
  mov R1, [BP+3]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7591
  mov R1, [BP+5]
  mov R2, [BP+6]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7591:
  jf R0, __while_7586_end
  mov R0, [BP+2]
  mov R1, global_spanstart
  mov R2, [BP+5]
  iadd R1, R2
  ...
  iadd R1, 1
  mov [BP+5], R1
  jmp __while_7586_start
__while_7586_end:
__while_7602_start:
__while_7602_continue:
  mov R0, [BP+6]
  mov R1, [BP+4]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7607
  mov R1, [BP+6]
  mov R2, [BP+5]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7607:
  jf R0, __while_7602_end
  mov R0, [BP+2]
  mov R1, global_spanstart
  mov R2, [BP+6]
  iadd R1, R2
...
__if_8480_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8492
  mov R1, [global_wallcmd_count]
  ilt R1, 3072
  and R0, R1
__LogicalAnd_ShortCircuit_8492:
  jf R0, __if_8480_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_8759_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8771
  mov R1, [global_wallcmd_count]
  ilt R1, 3072
  and R0, R1
__LogicalAnd_ShortCircuit_8771:
  jf R0, __if_8759_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_9056_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_9068
  mov R1, [global_wallcmd_count]
  ilt R1, 3072
  and R0, R1
__LogicalAnd_ShortCircuit_9068:
...
__if_9632_start:
  ...
  mov R0, [R1]
  ieq R0, 53
  jf R0, __LogicalAnd_ShortCircuit_9639
  mov R2, [global_backsector]
  iadd R2, 3
  mov R1, [R2]
  ieq R1, 53
  and R0, R1
__LogicalAnd_ShortCircuit_9639:
  jf R0, __if_9632_end
  mov R1, [global_backsector]
  iadd R1, 1
  mov R0, [R1]
...
__if_9661_start:
  ...
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_9667
  mov R2, [global_backsector]
  iadd R2, 2
  mov R1, [R2]
  ...
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_9667:
  jt R0, __LogicalOr_ShortCircuit_9673
  mov R2, [global_backsector]
  iadd R2, 4
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_9673:
  jf R0, __if_9661_else
  mov R0, 1
  mov [global_markfloor], R0
  jmp __if_9661_end
__if_9661_else:
...
__if_9683_start:
  ...
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_9689
  mov R2, [global_backsector]
  iadd R2, 3
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_9689:
  jt R0, __LogicalOr_ShortCircuit_9695
  mov R2, [global_backsector]
  iadd R2, 4
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_9695:
  jf R0, __if_9683_else
  mov R0, 1
  mov [global_markceiling], R0
  jmp __if_9683_end
__if_9683_else:
...
__if_9705_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_9713
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  iadd R3, 1
...
__if_9941_start:
  ...
  mov R1, [global_viewz]
  ile R0, R1
  jf R0, __LogicalAnd_ShortCircuit_9948
  mov R2, [global_frontsector]
  iadd R2, 3
  mov R1, [R2]
  ine R1, 53
  and R0, R1
__LogicalAnd_ShortCircuit_9948:
  jf R0, __if_9941_end
  mov R0, 0
  mov [global_markceiling], R0
__if_9941_end:
...
__if_10127_start:
  mov R0, [global_markceiling]
  jf R0, __LogicalAnd_ShortCircuit_10129
  mov R1, [global_ceilingplane]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_10129:
  jf R0, __if_10127_else
...
__if_10144_start:
  mov R0, [global_markfloor]
  jf R0, __LogicalAnd_ShortCircuit_10146
  mov R1, [global_floorplane]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_10146:
...
__if_10162_start:
  ...
  and R0, 2
  cib R0
  jt R0, __LogicalOr_ShortCircuit_10169
  mov R1, [global_maskedtexture]
  or R0, R1
__LogicalOr_ShortCircuit_10169:
  jf R0, __LogicalAnd_ShortCircuit_10171
  mov R2, [BP-7]
  iadd R2, 9
  mov R1, [R2]
  ieq R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_10171:
  jf R0, __if_10162_end
__if_10177_start:
  mov R0, [global_opening_used]
  mov R1, [global_rw_stopx]
  mov R2, [BP+2]
...
__for_10192_start:
  ...
  iadd R1, R2
  mov [R1], R0
__for_10192_continue:
  mov R0, [BP-8]
  mov R1, R0
  iadd R1, 1
  mov [BP-8], R1
  jmp __for_10192_start
__for_10192_end:
  mov R0, global_openings
  mov R1, [global_opening_used]
  mov R2, [BP+2]
...
__if_10233_start:
  ...
  and R0, 1
  cib R0
  jt R0, __LogicalOr_ShortCircuit_10240
  mov R1, [global_maskedtexture]
  or R0, R1
__LogicalOr_ShortCircuit_10240:
  jf R0, __LogicalAnd_ShortCircuit_10242
  mov R2, [BP-7]
  iadd R2, 10
  mov R1, [R2]
  ieq R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_10242:
  jf R0, __if_10233_end
__if_10248_start:
  mov R0, [global_opening_used]
  mov R1, [global_rw_stopx]
  mov R2, [BP+2]
...
__if_10304_start:
  mov R0, [global_maskedtexture]
  jf R0, __LogicalAnd_ShortCircuit_10306
  mov R2, [BP-7]
  iadd R2, 6
  mov R1, [R2]
  and R1, 2
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_10306:
...
__if_10322_start:
  mov R0, [global_maskedtexture]
  jf R0, __LogicalAnd_ShortCircuit_10324
  mov R2, [BP-7]
  iadd R2, 6
  mov R1, [R2]
  and R1, 1
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_10324:
  jf R0, __if_10322_end
  mov R1, [BP-7]
  iadd R1, 6
  mov R0, [R1]
  or R0, 1
...
__if_10614_start:
  mov R0, [BP-8]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_10619
  mov R1, [BP-17]
  mov R2, [BP-8]
  mov R3, [BP-5]
  iadd R2, R3
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_10619:
  jf R0, __if_10614_end
  mov R0, [BP-8]
  mov R1, [BP-5]
  iadd R0, R1
  mov R0, [R0]
...
__if_10631_start:
  mov R0, [BP-9]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_10636
  mov R1, [BP-16]
  mov R2, [BP-9]
  mov R3, [BP-5]
  iadd R2, R3
  ...
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_10636:
...
__if_10532_end:
  ...
  iadd R0, R1
  mov [BP-3], R0
__for_10522_continue:
  mov R0, [BP-5]
  mov R1, R0
  iadd R1, 1
  mov [BP-5], R1
  jmp __for_10522_start
__for_10522_end:
...
__if_11452_start:
  mov R0, [BP-9]
  ilt R0, 0
  jf R0, __if_11452_end
  jmp __function_R_ProjectSprite_return
__if_11452_end:
__if_11457_start:
  mov R0, [global_visspr_count]
  ige R0, 64
  jf R0, __if_11457_end
  jmp __function_R_ProjectSprite_return
__if_11457_end:
...
__for_11613_start:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __for_11613_end
  mov R1, [BP-1]
  mov [SP], R1
  call __function_R_ProjectSprite
__for_11613_continue:
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
  mov [BP-1], R0
  jmp __for_11613_start
__for_11613_end:
...
__for_11674_end:
  ...
  iadd R1, R2
  mov [R1], R0
__for_11651_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_11651_start
__for_11651_end:
...
__if_11834_start:
  mov R0, [BP-13]
  ige R0, 0
  jf R0, __LogicalAnd_ShortCircuit_11839
  mov R1, [BP-13]
  mov R2, [BP-5]
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_11839:
  jf R0, __if_11834_end
  mov R0, [BP-9]
  iadd R0, 65536
  isub R0, 1
  shl R0, -16
...
__if_11834_end:
  ...
  iadd R0, R1
  mov [BP-7], R0
__for_11798_continue:
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 1
  mov [BP-12], R1
  jmp __for_11798_start
__for_11798_end:
...
__for_11991_start:
  ...
  iadd R1, R2
  mov [R1], R0
__for_11991_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_11991_start
__for_11991_end:
  mov R0, [global_ds_count]
  isub R0, 1
  mov [BP-2], R0
...
__if_12033_start:
  ...
  mov R1, [R2]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_12041
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [BP+2]
  ...
  ilt R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_12041:
  jt R0, __LogicalOr_ShortCircuit_12054
  mov R2, [BP-1]
  iadd R2, 6
  mov R1, [R2]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_12049
  mov R3, [BP-1]
  iadd R3, 11
  mov R2, [R3]
  ieq R2, -1
  and R1, R2
__LogicalAnd_ShortCircuit_12049:
  or R0, R1
__LogicalOr_ShortCircuit_12054:
  jf R0, __if_12033_end
  jmp __for_12015_continue
__if_12033_end:
__if_12056_start:
  mov R1, [BP-1]
  iadd R1, 1
...
__if_12108_start:
  ...
  mov R2, [R3]
  ilt R1, R2
  jt R1, __LogicalOr_ShortCircuit_12127
  mov R2, [BP-7]
  mov R4, [BP+2]
  iadd R4, 7
  mov R3, [R4]
  ilt R2, R3
  jf R2, __LogicalAnd_ShortCircuit_12126
  mov R5, [BP+2]
  iadd R5, 2
  mov R4, [R5]
  mov [SP], R4
  ...
  bnot R3
  and R2, R3
__LogicalAnd_ShortCircuit_12126:
  or R1, R2
__LogicalOr_ShortCircuit_12127:
  mov R0, R1
  jf R0, __if_12108_end
__if_12129_start:
  mov R1, [BP-1]
  iadd R1, 11
  mov R0, [R1]
...
__if_12175_start:
  ...
  mov [R1], R0
__if_12175_end:
__for_12166_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12166_start
__for_12166_end:
  jmp __if_12161_end
__if_12161_else:
__if_12190_start:
...
__if_12204_start:
  ...
  mov [R1], R0
__if_12204_end:
__for_12195_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12195_start
__for_12195_end:
  jmp __if_12190_end
__if_12190_else:
__if_12219_start:
...
__if_12249_start:
  ...
  mov [R1], R0
__if_12249_end:
__for_12224_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12224_start
__for_12224_end:
__if_12219_end:
__if_12190_end:
__if_12161_end:
__for_12015_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_12015_start
__for_12015_end:
  mov R1, [BP+2]
  mov R0, [R1]
  mov [BP-3], R0
...
__if_12288_start:
  ...
  mov [R1], R0
__if_12288_end:
__for_12264_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12264_start
__for_12264_end:
  mov R0, global_spr_clipbot
  mov [global_mfloorclip], R0
  mov R0, global_spr_cliptop
...
__if_12666_end:
__for_12656_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12656_start
__for_12656_end:
...
__for_12689_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12689_start
__for_12689_end:
  mov R0, [global_ds_count]
  isub R0, 1
  mov [BP-2], R0
...
__if_12723_start:
  ...
  call __function_R_RenderMaskedSegRange
__if_12723_end:
__for_12705_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_12705_start
__for_12705_end:
...
__while_12756_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_12756_end
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 2
  mov [BP-2], R1
  jmp __while_12756_start
__while_12756_end:
__if_12765_start:
  mov R0, [BP+2]
  mov R2, [BP-2]
...
__while_12787_start:
__while_12787_continue:
  mov R0, [BP-1]
  mov R1, [BP-2]
  ine R0, R1
  jf R0, __while_12787_end
  lea R13, [BP-1]
  mov R13, [R13]
  mov R12, [BP-1]
  isub R12, 2
...
__if_12821_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jf R0, __if_12821_end
  jmp __function_R_ClipSolidWallSegment_return
__if_12821_end:
  mov R0, [BP-2]
  mov [BP-1], R0
__while_12830_start:
__while_12830_continue:
  mov R0, [BP+3]
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
...
__if_12855_start:
  ...
  iadd R1, 1
  mov [R1], R0
  jmp __label_12877_crunch
__if_12855_end:
  jmp __while_12830_start
__while_12830_end:
  mov R2, [BP-1]
  iadd R2, 1
  mov R1, [R2]
  ...
  iadd R1, 1
  mov [R1], R0
__label_12877_crunch:
__if_12878_start:
  mov R0, [BP-1]
  mov R1, [BP-2]
  ieq R0, R1
  jf R0, __if_12878_end
  jmp __function_R_ClipSolidWallSegment_return
__if_12878_end:
__while_12883_start:
__while_12883_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 2
  mov [BP-1], R1
...
__while_12909_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_12909_end
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 2
  mov [BP-1], R1
  jmp __while_12909_start
__while_12909_end:
__if_12918_start:
  mov R0, [BP+2]
  mov R2, [BP-1]
...
__if_12942_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jf R0, __if_12942_end
  jmp __function_R_ClipPassWallSegment_return
__if_12942_end:
__while_12948_start:
__while_12948_continue:
  mov R0, [BP+3]
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
...
__if_12973_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jf R0, __if_12973_end
  jmp __function_R_ClipPassWallSegment_return
__if_12973_end:
  jmp __while_12948_start
__while_12948_end:
  mov R2, [BP-1]
  iadd R2, 1
  mov R1, [R2]
...
__if_13196_start:
  ...
  ine R0, -1
  bnot R0
  jf R0, __if_13196_end
  jmp __label_13258_clipsolid
__if_13196_end:
__if_13200_start:
  mov R1, [global_backsector]
  iadd R1, 1
  ...
  mov R1, [R2]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_13208
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_13208:
...
__if_13213_start:
  ...
  mov R1, [R2]
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_13221
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  mov R2, [R3]
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_13221:
  jf R0, __if_13213_end
  jmp __label_13251_clippass
__if_13213_end:
__if_13226_start:
  mov R1, [global_backsector]
  iadd R1, 3
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_13234
  mov R2, [global_backsector]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13234:
  jf R0, __LogicalAnd_ShortCircuit_13240
  mov R2, [global_backsector]
  iadd R2, 4
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13240:
  jf R0, __LogicalAnd_ShortCircuit_13247
  mov R3, [global_curline]
  iadd R3, 4
  mov R2, [R3]
  iadd R2, 4
  ...
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_13247:
  jf R0, __if_13226_end
  jmp __function_R_AddLine_return
__if_13226_end:
__label_13251_clippass:
  mov R1, [BP-1]
  mov [SP], R1
  mov R1, [BP-2]
  isub R1, 1
...
__if_13593_end:
  ...
  mov [BP-12], R0
__while_13604_start:
__while_13604_continue:
  mov R1, [BP-12]
  iadd R1, 1
  mov R0, [R1]
  mov R1, [BP-14]
  ilt R0, R1
  jf R0, __while_13604_end
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 2
  mov [BP-12], R1
  jmp __while_13604_start
__while_13604_end:
__if_13611_start:
  mov R0, [BP-13]
  mov R2, [BP-12]
  mov R1, [R2]
  ige R0, R1
  jf R0, __LogicalAnd_ShortCircuit_13617
  mov R1, [BP-14]
  mov R3, [BP-12]
  iadd R3, 1
  mov R2, [R3]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13617:
  jf R0, __if_13611_end
  mov R0, 0
  jmp __function_R_CheckBBox_return
__if_13611_end:
  mov R0, 1
...
__if_13671_start:
  ...
  mov R1, [global_viewz]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_13678
  mov R2, [global_frontsector]
  iadd R2, 3
  mov R1, [R2]
  ieq R1, 53
  or R0, R1
__LogicalOr_ShortCircuit_13678:
...
__while_13695_start:
__while_13695_continue:
  mov R0, [BP-1]
  igt R0, 0
  jf R0, __while_13695_end
  mov R1, [BP-2]
  mov [SP], R1
...
__if_14927_start:
  mov R0, [BP+2]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_14932
  mov R1, [BP+3]
  ilt R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_14932:
  jt R0, __LogicalOr_ShortCircuit_14936
  mov R1, [BP+2]
  mov R2, [global_bmapwidth]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_14936:
  jt R0, __LogicalOr_ShortCircuit_14940
  mov R1, [BP+3]
  mov R2, [global_bmapheight]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_14940:
  jf R0, __if_14927_end
  mov R0, 1
...
__if_14976_start:
  ...
  mov R1, [global_validcount]
  ieq R0, R1
  jf R0, __if_14976_end
  jmp __for_14960_continue
__if_14976_end:
  mov R0, [global_validcount]
  mov R1, [BP-3]
  iadd R1, 14
...
__if_14986_start:
  ...
  bnot R1
  mov R0, R1
  jf R0, __if_14986_end
  mov R0, 0
  jmp __function_P_BlockLinesIterator_return
__if_14986_end:
__for_14960_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_14960_start
__for_14960_end:
  mov R0, 1
...
__if_15001_start:
  mov R0, [BP+2]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_15006
  mov R1, [BP+3]
  ilt R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_15006:
  jt R0, __LogicalOr_ShortCircuit_15010
  mov R1, [BP+2]
  mov R2, [global_bmapwidth]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15010:
  jt R0, __LogicalOr_ShortCircuit_15014
  mov R1, [BP+3]
  mov R2, [global_bmapheight]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15014:
  jf R0, __if_15001_end
  mov R0, 1
...
__if_15036_start:
  ...
  bnot R1
  mov R0, R1
  jf R0, __if_15036_end
  mov R0, 0
  jmp __function_P_BlockThingsIterator_return
__if_15036_end:
__for_15019_continue:
  mov R1, [BP-1]
  iadd R1, 9
  mov R0, [R1]
  mov [BP-1], R0
  jmp __for_15019_start
__for_15019_end:
  mov R0, 1
...
__if_15066_start:
  mov R0, [1698316]
  igt R0, 1048576
  jt R0, __LogicalOr_ShortCircuit_15075
  mov R1, [1698317]
  igt R1, 1048576
  or R0, R1
__LogicalOr_ShortCircuit_15075:
  jt R0, __LogicalOr_ShortCircuit_15082
  mov R1, [1698316]
  ilt R1, -1048576
  or R0, R1
__LogicalOr_ShortCircuit_15082:
  jt R0, __LogicalOr_ShortCircuit_15090
  mov R1, [1698317]
  ilt R1, -1048576
  or R0, R1
__LogicalOr_ShortCircuit_15090:
  jf R0, __if_15066_else
  mov R4, [BP+2]
  mov R3, [R4]
  mov R2, [R3]
  mov [SP], R2
...
__if_15159_start:
  mov R0, [BP-3]
  ilt R0, 0
  jf R0, __if_15159_end
  mov R0, 1
  jmp __function_PIT_AddLineIntercepts_return
__if_15159_end:
__if_15165_start:
  mov R0, [global_earlyout]
  jf R0, __LogicalAnd_ShortCircuit_15167
  mov R1, [BP-3]
  ilt R1, 65536
  and R0, R1
__LogicalAnd_ShortCircuit_15167:
  jf R0, __LogicalAnd_ShortCircuit_15174
  mov R2, [BP+2]
  iadd R2, 16
  mov R1, [R2]
  ine R1, -1
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_15174:
  jf R0, __if_15165_end
  mov R0, 0
  jmp __function_PIT_AddLineIntercepts_return
__if_15165_end:
__if_15177_start:
...
__function_P_TraverseIntercepts:
  ...
  mov [BP-1], R0
__while_15401_start:
__while_15401_continue:
  mov R0, [BP-1]
  mov R1, R0
  isub R1, 1
  mov [BP-1], R1
  cib R0
  jf R0, __while_15401_end
  mov R0, 2147483647
  mov [BP-2], R0
  mov R0, 0
  mov [BP-3], R0
...
__if_15418_start:
  ...
  mov [BP-4], R0
__if_15418_end:
__for_15408_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_15408_start
__for_15408_end:
__if_15438_start:
  mov R0, [BP-2]
  mov R1, [BP+3]
  igt R0, R1
  jf R0, __if_15438_end
  mov R0, 1
...
__if_16586_start:
  ...
  mov R1, [global_validcount]
  ieq R0, R1
  jf R0, __if_16586_end
  jmp __for_16563_continue
__if_16586_end:
  mov R0, [global_validcount]
  mov R1, [BP-2]
  iadd R1, 14
...
__if_16691_start:
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_16699
  mov R2, [BP-7]
  iadd R2, 1
  mov R1, [R2]
  mov R3, [BP-8]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_16699:
...
__if_16787_start:
  ...
  jmp __function_P_CrossSubsector_return
__if_16787_end:
__for_16563_continue:
  mov R0, [BP-19]
  mov R1, R0
  iadd R1, 1
  mov [BP-19], R1
  jmp __for_16563_start
__for_16563_end:
  mov R0, 1
...
__if_16801_start:
  ...
  and R0, 32768
  cib R0
  jf R0, __if_16801_end
__if_16806_start:
  mov R0, [BP+2]
  ieq R0, -1
  jf R0, __if_16806_end
  mov R1, 0
  mov [SP], R1
...
__for_17077_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17077_start
__for_17077_end:
  mov R0, 0
  mov [BP-1], R0
__for_17097_start:
...
__for_17097_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17097_start
__for_17097_end:
  mov R0, 0
  mov [BP-1], R0
__for_17157_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17157_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17157_start
__for_17157_end:
  mov R0, 0
  mov [BP-1], R0
__for_17175_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17175_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17175_start
__for_17175_end:
  mov R0, 0
  mov [BP-1], R0
__for_17193_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17193_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17193_start
__for_17193_end:
  ...
  mov R1, [BP-4]
  igt R1, 65520
  jf R1, __LogicalAnd_ShortCircuit_17259
  mov R2, [BP-4]
  ilt R2, 65552
  and R1, R2
__LogicalAnd_ShortCircuit_17259:
  mov [SP], R1
  call __function_Check
  mov R0, -1073741824
  mov [BP-5], R0
  ...
  mov R1, [BP-10]
  ieq R1, 0x80000000
  jf R1, __LogicalAnd_ShortCircuit_17338
  mov R2, [BP-8]
  ieq R2, 2147483647
  and R1, R2
__LogicalAnd_ShortCircuit_17338:
  mov [SP], R1
  call __function_Check
  lea R1, [BP-10]
  mov [SP], R1
  ...
  mov R1, [BP-8]
  ieq R1, -50
  jf R1, __LogicalAnd_ShortCircuit_17360
  mov R2, [BP-7]
  ieq R2, 0x80000000
  and R1, R2
__LogicalAnd_ShortCircuit_17360:
  mov [SP], R1
  call __function_Check
  lea R1, [BP-10]
  mov [SP], R1
  ...
  mov R1, [BP-7]
  ieq R1, 150
  jf R1, __LogicalAnd_ShortCircuit_17376
  mov R2, [BP-9]
  ieq R2, 100
  and R1, R2
__LogicalAnd_ShortCircuit_17376:
  jf R1, __LogicalAnd_ShortCircuit_17382
  mov R2, [BP-10]
  ieq R2, 300
  and R1, R2
__LogicalAnd_ShortCircuit_17382:
  mov [SP], R1
  call __function_Check
  ...
  mov R1, [R1]
  ieq R1, 0
  jf R1, __LogicalAnd_ShortCircuit_17434
  mov R2, [BP-15]
  iadd R2, 199
  mov R2, [R2]
  ieq R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_17434:
  mov [SP], R1
  call __function_Check
  mov R1, 50
  mov [SP], R1
...
__if_17511_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17524
  mov R1, __embedded_gen_segs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 467
  or R0, R1
__LogicalOr_ShortCircuit_17524:
...
__if_17549_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17562
  mov R1, __embedded_gen_segs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 475
  or R0, R1
__LogicalOr_ShortCircuit_17562:
...
__if_17583_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17596
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 85
  or R0, R1
__LogicalOr_ShortCircuit_17596:
...
__if_17602_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17615
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17615:
  jf R0, __if_17602_end
  mov R0, 0
  mov [BP-17], R0
__if_17602_end:
__if_17621_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17634
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17634:
  jf R0, __if_17621_end
  mov R0, 0
  mov [BP-17], R0
__if_17621_end:
__if_17640_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17653
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17653:
  jf R0, __if_17640_end
  mov R0, 0
  mov [BP-17], R0
__if_17640_end:
__for_17573_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17573_start
__for_17573_end:
  mov R1, [BP-17]
  mov [SP], R1
  call __function_Check
...
__for_17943_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17943_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17943_start
__for_17943_end:
...
__if_18001_start:
  ...
  mov R0, [R1]
  ieq R0, -1
  jf R0, __if_18001_end
  mov R0, 0
  mov [BP-18], R0
__if_18001_end:
__for_17992_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17992_start
__for_17992_end:
  mov R1, [BP-18]
  mov [SP], R1
  call __function_Check
...
__if_18028_start:
  ...
  mov [BP-20], R0
__if_18028_end:
__for_18019_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18019_start
__for_18019_end:
  mov R1, [BP-19]
  ine R1, 0
  jt R1, __LogicalOr_ShortCircuit_18060
  mov R2, [BP-20]
  ine R2, 0
  or R1, R2
__LogicalOr_ShortCircuit_18060:
  mov [SP], R1
  call __function_Check
  mov R1, [BP-19]
  mov [SP], R1
...
__for_18094_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_18094_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18094_start
__for_18094_end:
  mov R1, __embedded_gen_states
  iadd R1, 98
  iadd R1, 1
...
__if_18221_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18234
  mov R1, __embedded_gen_states
  mov R2, [BP-1]
  imul R2, 7
  iadd R1, R2
  ...
  ige R1, 138
  or R0, R1
__LogicalOr_ShortCircuit_18234:
  jf R0, __if_18221_end
  mov R0, 0
  mov [BP-22], R0
__if_18221_end:
__if_18240_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18253
  mov R1, __embedded_gen_states
  mov R2, [BP-1]
  imul R2, 7
  iadd R1, R2
  ...
  ige R1, 967
  or R0, R1
__LogicalOr_ShortCircuit_18253:
  jf R0, __if_18240_end
  mov R0, 0
  mov [BP-22], R0
__if_18240_end:
__if_18259_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18272
  mov R1, __embedded_gen_states
  mov R2, [BP-1]
  imul R2, 7
  iadd R1, R2
  ...
  ige R1, 75
  or R0, R1
__LogicalOr_ShortCircuit_18272:
  jf R0, __if_18259_end
  mov R0, 0
  mov [BP-22], R0
__if_18259_end:
__for_18211_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18211_start
__for_18211_end:
  mov R1, [BP-22]
  mov [SP], R1
  call __function_Check
...
__if_18323_end:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_18280_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18280_start
__for_18280_end:
...
__if_18377_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18386
  mov R1, global_viewangletox
  mov R2, [BP-1]
  iadd R1, R2
  mov R1, [R1]
  ...
  igt R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_18386:
  jf R0, __if_18377_end
  mov R0, 0
  mov [BP-23], R0
__if_18377_end:
__for_18354_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18354_start
__for_18354_end:
  mov R1, [BP-23]
  mov [SP], R1
  call __function_Check
...
__if_18399_end:
  ...
  call __function_Check
__while_18413_start:
__while_18413_continue:
  mov R0, 1
  jf R0, __while_18413_end
__if_18416_start:
  mov R0, [global_AllPassed]
  jf R0, __if_18416_else
  mov R1, -16711936
  mov [SP], R1
...
__literal_string_18424:
  string "VIRCONDOOM CORE ALL GREEN"
__literal_string_18428:
  string "TOTAL CHECKS"
__literal_string_18439:
  string "CORE FAIL - FIRST FAIL CHECK"
__literal_string_18447:
  string "EXPECTED"
__literal_string_18455:
  string "ACTUAL"
__literal_string_18463:
  string "TOTAL CHECKS"
