...
__if_4799_start:
  ...
  mov R0, [R1]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_4802
  mov R2, [BP-3]
  iadd R2, 16
  mov R1, [R2]
  mov R3, [BP-3]
  ...
  ine R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_4802:
  jf R0, __if_4799_end
  mov R3, [BP-3]
  iadd R3, 16
  mov R2, [R3]
...
__if_5343_start:
  mov R0, [BP+2]
  bnot R0
  jf R0, __LogicalAnd_ShortCircuit_5347
  mov R1, [BP+3]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_5347:
  jf R0, __if_5343_end
  mov R0, 0
...
__if_5353_start:
  mov R0, [BP+2]
  ige R0, 0
  jf R0, __if_5353_else
__if_5358_start:
  mov R0, [BP+3]
  ige R0, 0
  jf R0, __if_5358_else
__if_5363_start:
  mov R0, [BP+2]
  mov R1, [BP+3]
  igt R0, R1
  jf R0, __if_5363_else
__if_5369_start:
  mov R0, [BP+2]
  ilt R0, 512
  jf R0, __if_5369_else
  mov R0, 2048
  mov [BP-1], R0
  jmp __if_5369_end
__if_5369_else:
...
__if_5448_start:
  ...
  mov R1, [BP+3]
  igt R0, R1
  jf R0, __if_5448_else
__if_5454_start:
  mov R0, [BP+2]
  ilt R0, 512
  jf R0, __if_5454_else
  mov R0, 2048
  mov [BP-1], R0
  jmp __if_5454_end
__if_5454_else:
...
__if_5532_start:
  mov R0, [BP+3]
  ige R0, 0
  jf R0, __if_5532_else
__if_5537_start:
  mov R0, [BP+2]
  mov R1, [BP+3]
  igt R0, R1
  jf R0, __if_5537_else
__if_5543_start:
  mov R0, [BP+2]
  ilt R0, 512
  jf R0, __if_5543_else
  mov R0, 2048
  mov [BP-1], R0
  jmp __if_5543_end
__if_5543_else:
...
__if_5624_start:
  ...
  mov R1, [BP+3]
  igt R0, R1
  jf R0, __if_5624_else
__if_5630_start:
  mov R0, [BP+2]
  ilt R0, 512
  jf R0, __if_5630_else
  mov R0, 2048
  mov [BP-1], R0
  jmp __if_5630_end
__if_5630_else:
...
__if_6297_end:
  ...
  mov [BP-3], R0
__while_6307_start:
__while_6307_continue:
  mov R0, [BP-3]
  and R0, 32768
  bnot R0
  jf R0, __while_6307_end
  mov R0, [global_nodes]
  mov R1, [BP-3]
  imul R1, 14
  iadd R0, R1
...
__if_7045_end:
  ...
  mov [BP-12], R0
__while_7059_start:
__while_7059_continue:
  mov R0, [BP-11]
  mov R1, [BP+5]
  mov R2, [BP-8]
  iadd R1, R2
  ilt R0, R1
  jf R0, __while_7059_end
  mov R0, [BP-10]
  mov R1, [BP-2]
  imod R0, R1
  mov [BP-13], R0
...
__if_7171_start:
  mov R0, [BP-19]
  igt R0, 0
  jf R0, __LogicalAnd_ShortCircuit_7176
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_7176:
  jf R0, __if_7171_end
  mov R0, [global_perf_draws]
  mov R1, R0
  iadd R1, 1
...
__if_7262_start:
  ...
  ige R0, R1
  jf R0, __if_7262_end
  jmp __while_7059_end
__if_7262_end:
  jmp __while_7059_start
__while_7059_end:
...
__if_7511_start:
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7517
  mov R1, [BP+3]
  mov R3, [BP-1]
  iadd R3, 1
  mov R2, [R3]
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7517:
  jf R0, __LogicalAnd_ShortCircuit_7522
  mov R1, [BP+4]
  mov R3, [BP-1]
  iadd R3, 2
  mov R2, [R3]
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7522:
  jf R0, __if_7511_end
  mov R0, [BP-1]
...
__while_7801_continue:
  ...
  mov R1, [BP+5]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7806
  mov R1, [BP+3]
  mov R2, [BP+4]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7806:
...
__while_7801_end:
__while_7830_start:
__while_7830_continue:
  mov R0, [BP+4]
  mov R1, [BP+6]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7835
  mov R1, [BP+4]
  mov R2, [BP+3]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7835:
  jf R0, __while_7830_end
  mov R1, global_spanstart
  mov R2, [BP+4]
  iadd R1, R2
  mov R1, [R1]
...
__while_7859_end:
__while_7875_start:
__while_7875_continue:
  mov R0, [BP+6]
  mov R1, [BP+4]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_7880
  mov R1, [BP+6]
  mov R2, [BP+5]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7880:
  jf R0, __while_7875_end
  mov R0, [BP+2]
  mov R1, global_spanstart
  mov R2, [BP+6]
  iadd R1, R2
...
__if_7965_start:
  mov R0, [BP-6]
  ine R0, 255
  jf R0, __LogicalAnd_ShortCircuit_7970
  mov R1, [BP-6]
  mov R2, [BP-7]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_7970:
  jf R0, __if_7965_end
...
__if_8753_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_8765
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_8765:
...
__if_9032_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_9044
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_9044:
  jf R0, __if_9032_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_9329_start:
  ...
  mov R1, [BP-31]
  fge R0, R1
  jf R0, __LogicalAnd_ShortCircuit_9341
  mov R1, [global_wallcmd_count]
  ilt R1, 4096
  and R0, R1
__LogicalAnd_ShortCircuit_9341:
  jf R0, __if_9329_else
  mov R0, [global_perf_columns]
  mov R1, R0
  iadd R1, 1
  mov [global_perf_columns], R1
...
__if_9934_start:
  ...
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_9940
  mov R2, [global_backsector]
  iadd R2, 2
  mov R1, [R2]
...
__if_9956_start:
  ...
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_9962
  mov R2, [global_backsector]
  iadd R2, 3
  mov R1, [R2]
  mov R3, [global_frontsector]
...
__if_9978_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_9986
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  iadd R3, 1
...
__if_10214_start:
  ...
  mov R1, [global_viewz]
  ile R0, R1
  jf R0, __LogicalAnd_ShortCircuit_10221
  mov R2, [global_frontsector]
  iadd R2, 3
  mov R1, [R2]
  ine R1, 53
  and R0, R1
__LogicalAnd_ShortCircuit_10221:
  jf R0, __if_10214_end
  mov R0, 0
  mov [global_markceiling], R0
__if_10214_end:
  mov R0, [global_worldtop]
...
__if_10400_start:
  mov R0, [global_markceiling]
  jf R0, __LogicalAnd_ShortCircuit_10402
  mov R1, [global_ceilingplane]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_10402:
  jf R0, __if_10400_else
...
__if_10417_start:
  mov R0, [global_markfloor]
  jf R0, __LogicalAnd_ShortCircuit_10419
  mov R1, [global_floorplane]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_10419:
  jf R0, __if_10417_else
...
__if_10435_start:
  ...
  and R0, 2
  cib R0
  jt R0, __LogicalOr_ShortCircuit_10442
  mov R1, [global_maskedtexture]
  or R0, R1
__LogicalOr_ShortCircuit_10442:
  jf R0, __LogicalAnd_ShortCircuit_10444
  mov R2, [BP-7]
  iadd R2, 9
  mov R1, [R2]
  ieq R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_10444:
...
__for_10465_start:
  ...
  iadd R1, R2
  mov [R1], R0
__for_10465_continue:
  mov R0, [BP-8]
  mov R1, R0
  iadd R1, 1
  mov [BP-8], R1
  jmp __for_10465_start
__for_10465_end:
  mov R0, global_openings
  mov R1, [global_opening_used]
  mov R2, [BP+2]
...
__if_10506_start:
  ...
  and R0, 1
  cib R0
  jt R0, __LogicalOr_ShortCircuit_10513
  mov R1, [global_maskedtexture]
  or R0, R1
__LogicalOr_ShortCircuit_10513:
  jf R0, __LogicalAnd_ShortCircuit_10515
  mov R2, [BP-7]
  iadd R2, 10
  mov R1, [R2]
  ieq R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_10515:
  jf R0, __if_10506_end
__if_10521_start:
  mov R0, [global_opening_used]
  mov R1, [global_rw_stopx]
  mov R2, [BP+2]
...
__for_10536_start:
  ...
  iadd R1, R2
  mov [R1], R0
__for_10536_continue:
  mov R0, [BP-8]
  mov R1, R0
  iadd R1, 1
  mov [BP-8], R1
  jmp __for_10536_start
__for_10536_end:
  mov R0, global_openings
  mov R1, [global_opening_used]
  mov R2, [BP+2]
...
__if_10577_start:
  mov R0, [global_maskedtexture]
  jf R0, __LogicalAnd_ShortCircuit_10579
  mov R2, [BP-7]
  iadd R2, 6
  mov R1, [R2]
  and R1, 2
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_10579:
  jf R0, __if_10577_end
  mov R1, [BP-7]
  iadd R1, 6
  mov R0, [R1]
  or R0, 2
...
__if_10595_start:
  mov R0, [global_maskedtexture]
  jf R0, __LogicalAnd_ShortCircuit_10597
  mov R2, [BP-7]
  iadd R2, 6
  mov R1, [R2]
  and R1, 1
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_10597:
  jf R0, __if_10595_end
  mov R1, [BP-7]
  iadd R1, 6
  mov R0, [R1]
  or R0, 1
...
__if_10887_start:
  mov R0, [BP-8]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_10892
  mov R1, [BP-17]
  mov R2, [BP-8]
  mov R3, [BP-5]
  iadd R2, R3
  ...
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_10892:
  jf R0, __if_10887_end
  mov R0, [BP-8]
  mov R1, [BP-5]
  iadd R0, R1
  mov R0, [R0]
...
__if_10904_start:
  mov R0, [BP-9]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_10909
  mov R1, [BP-16]
  mov R2, [BP-9]
  mov R3, [BP-5]
  iadd R2, R3
  ...
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_10909:
...
__if_10805_end:
  ...
  iadd R0, R1
  mov [BP-3], R0
__for_10795_continue:
  mov R0, [BP-5]
  mov R1, R0
  iadd R1, 1
  mov [BP-5], R1
  jmp __for_10795_start
__for_10795_end:
...
__if_11761_start:
  mov R0, [BP-9]
  ilt R0, 0
  jf R0, __if_11761_end
  jmp __function_R_ProjectSprite_return
__if_11761_end:
__if_11766_start:
  mov R0, [global_visspr_count]
  ige R0, 64
  jf R0, __if_11766_end
  jmp __function_R_ProjectSprite_return
__if_11766_end:
...
__for_11922_start:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __for_11922_end
  mov R1, [BP-1]
  mov [SP], R1
  call __function_R_ProjectSprite
__for_11922_continue:
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
  mov [BP-1], R0
  jmp __for_11922_start
__for_11922_end:
...
__for_11946_start:
  ...
  mov R1, [global_visspr_count]
  ilt R0, R1
  jf R0, __for_11946_end
  mov R0, [BP-1]
  mov R1, global_visspr_order
  mov R2, [BP-1]
  iadd R1, R2
  mov [R1], R0
__for_11946_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_11946_start
__for_11946_end:
  mov R0, 0
  mov [BP-1], R0
__for_11960_start:
...
__if_11995_start:
  ...
  mov [BP-3], R0
__if_11995_end:
__for_11983_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_11983_start
__for_11983_end:
  ...
  iadd R1, R2
  mov [R1], R0
__for_11960_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_11960_start
__for_11960_end:
...
__if_12143_start:
  mov R0, [BP-13]
  ige R0, 0
  jf R0, __LogicalAnd_ShortCircuit_12148
  mov R1, [BP-13]
  mov R2, [BP-5]
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_12148:
...
__for_12300_start:
  ...
  iadd R1, R2
  mov [R1], R0
__for_12300_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12300_start
__for_12300_end:
  mov R0, [global_ds_count]
  isub R0, 1
  mov [BP-2], R0
...
__if_12342_start:
  ...
  mov R1, [R2]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_12350
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [BP+2]
  ...
  ilt R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_12350:
  jt R0, __LogicalOr_ShortCircuit_12363
  mov R2, [BP-1]
  iadd R2, 6
  mov R1, [R2]
  bnot R1
  jf R1, __LogicalAnd_ShortCircuit_12358
  mov R3, [BP-1]
  iadd R3, 11
  mov R2, [R3]
  ieq R2, -1
  and R1, R2
__LogicalAnd_ShortCircuit_12358:
  or R0, R1
__LogicalOr_ShortCircuit_12363:
  jf R0, __if_12342_end
  jmp __for_12324_continue
__if_12342_end:
__if_12365_start:
  mov R1, [BP-1]
  iadd R1, 1
...
__if_12417_start:
  ...
  mov R2, [R3]
  ilt R1, R2
  jt R1, __LogicalOr_ShortCircuit_12436
  mov R2, [BP-7]
  mov R4, [BP+2]
  iadd R4, 7
  mov R3, [R4]
  ilt R2, R3
  jf R2, __LogicalAnd_ShortCircuit_12435
  mov R5, [BP+2]
  iadd R5, 2
  mov R4, [R5]
  mov [SP], R4
  ...
  bnot R3
  and R2, R3
__LogicalAnd_ShortCircuit_12435:
  or R1, R2
__LogicalOr_ShortCircuit_12436:
  mov R0, R1
...
__if_12484_start:
  ...
  mov [R1], R0
__if_12484_end:
__for_12475_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12475_start
__for_12475_end:
  jmp __if_12470_end
__if_12470_else:
__if_12499_start:
...
__if_12513_start:
  ...
  mov [R1], R0
__if_12513_end:
__for_12504_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12504_start
__for_12504_end:
  jmp __if_12499_end
__if_12499_else:
__if_12528_start:
...
__if_12499_end:
__if_12470_end:
__for_12324_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_12324_start
__for_12324_end:
  mov R1, [BP+2]
  mov R0, [R1]
  mov [BP-3], R0
...
__if_12597_start:
  ...
  mov [R1], R0
__if_12597_end:
__for_12573_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_12573_start
__for_12573_end:
  mov R0, global_spr_clipbot
  mov [global_mfloorclip], R0
  mov R0, global_spr_cliptop
...
__if_12975_end:
__for_12965_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12965_start
__for_12965_end:
...
__for_12998_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_12998_start
__for_12998_end:
  mov R0, [global_ds_count]
  isub R0, 1
  mov [BP-2], R0
...
__if_13032_start:
  ...
  call __function_R_RenderMaskedSegRange
__if_13032_end:
__for_13014_continue:
  mov R0, [BP-2]
  mov R1, R0
  isub R1, 1
  mov [BP-2], R1
  jmp __for_13014_start
__for_13014_end:
...
__while_13065_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_13065_end
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 2
  mov [BP-2], R1
  jmp __while_13065_start
__while_13065_end:
__if_13074_start:
  mov R0, [BP+2]
  mov R2, [BP-2]
...
__while_13096_start:
__while_13096_continue:
  mov R0, [BP-1]
  mov R1, [BP-2]
  ine R0, R1
  jf R0, __while_13096_end
  lea R13, [BP-1]
  mov R13, [R13]
  mov R12, [BP-1]
  isub R12, 2
...
__if_13130_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jf R0, __if_13130_end
  jmp __function_R_ClipSolidWallSegment_return
__if_13130_end:
  mov R0, [BP-2]
  mov [BP-1], R0
__while_13139_start:
__while_13139_continue:
  mov R0, [BP+3]
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
...
__if_13164_start:
  ...
  iadd R1, 1
  mov [R1], R0
  jmp __label_13186_crunch
__if_13164_end:
  jmp __while_13139_start
__while_13139_end:
  mov R2, [BP-1]
  iadd R2, 1
  mov R1, [R2]
...
__while_13218_continue:
  ...
  isub R1, 1
  ilt R0, R1
  jf R0, __while_13218_end
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 2
  mov [BP-1], R1
  jmp __while_13218_start
__while_13218_end:
__if_13227_start:
  mov R0, [BP+2]
  mov R2, [BP-1]
...
__if_13251_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jf R0, __if_13251_end
  jmp __function_R_ClipPassWallSegment_return
__if_13251_end:
__while_13257_start:
__while_13257_continue:
  mov R0, [BP+3]
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
...
__if_13282_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jf R0, __if_13282_end
  jmp __function_R_ClipPassWallSegment_return
__if_13282_end:
  jmp __while_13257_start
__while_13257_end:
  mov R2, [BP-1]
  iadd R2, 1
  mov R1, [R2]
...
__if_13509_start:
  ...
  mov R1, [R2]
  ile R0, R1
  jt R0, __LogicalOr_ShortCircuit_13517
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_13517:
  jf R0, __if_13509_end
  jmp __label_13567_clipsolid
__if_13509_end:
__if_13522_start:
  mov R1, [global_backsector]
  ...
  mov R1, [R2]
  ine R0, R1
  jt R0, __LogicalOr_ShortCircuit_13530
  mov R2, [global_backsector]
  mov R1, [R2]
  mov R3, [global_frontsector]
  mov R2, [R3]
  ine R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_13530:
  jf R0, __if_13522_end
  jmp __label_13560_clippass
__if_13522_end:
__if_13535_start:
  mov R1, [global_backsector]
  iadd R1, 3
...
__LogicalAnd_ShortCircuit_13543:
  jf R0, __LogicalAnd_ShortCircuit_13549
  mov R2, [global_backsector]
  iadd R2, 4
  mov R1, [R2]
  mov R3, [global_frontsector]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13549:
  jf R0, __LogicalAnd_ShortCircuit_13556
  mov R3, [global_curline]
  iadd R3, 4
  mov R2, [R3]
  iadd R2, 4
  ...
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_13556:
  jf R0, __if_13535_end
  jmp __function_R_AddLine_return
__if_13535_end:
__label_13560_clippass:
  mov R1, [BP-1]
  mov [SP], R1
  mov R1, [BP-2]
  isub R1, 1
...
__if_13902_end:
  ...
  mov [BP-12], R0
__while_13913_start:
__while_13913_continue:
  mov R1, [BP-12]
  iadd R1, 1
  mov R0, [R1]
  mov R1, [BP-14]
  ilt R0, R1
  jf R0, __while_13913_end
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 2
  mov [BP-12], R1
  jmp __while_13913_start
__while_13913_end:
__if_13920_start:
  mov R0, [BP-13]
  mov R2, [BP-12]
  mov R1, [R2]
  ige R0, R1
  jf R0, __LogicalAnd_ShortCircuit_13926
  mov R1, [BP-14]
  mov R3, [BP-12]
  iadd R3, 1
  mov R2, [R3]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_13926:
  jf R0, __if_13920_end
  mov R0, 0
  jmp __function_R_CheckBBox_return
__if_13920_end:
  mov R0, 1
...
__if_13980_start:
  ...
  mov R1, [global_viewz]
  igt R0, R1
  jt R0, __LogicalOr_ShortCircuit_13987
  mov R2, [global_frontsector]
  iadd R2, 3
  mov R1, [R2]
  ieq R1, 53
  or R0, R1
__LogicalOr_ShortCircuit_13987:
  jf R0, __if_13980_else
  mov R3, [global_frontsector]
  iadd R3, 1
  mov R2, [R3]
  mov [SP], R2
...
__while_14004_start:
__while_14004_continue:
  mov R0, [BP-1]
  igt R0, 0
  jf R0, __while_14004_end
  mov R1, [BP-2]
  mov [SP], R1
...
__if_14021_start:
  ...
  and R0, 32768
  cib R0
  jf R0, __if_14021_end
__if_14026_start:
  mov R0, [BP+2]
  ieq R0, -1
  jf R0, __if_14026_else
  mov R1, 0
  mov [SP], R1
...
__if_15236_start:
  mov R0, [BP+2]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_15241
  mov R1, [BP+3]
  ilt R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_15241:
  jt R0, __LogicalOr_ShortCircuit_15245
  mov R1, [BP+2]
  mov R2, [global_bmapwidth]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15245:
  jt R0, __LogicalOr_ShortCircuit_15249
  mov R1, [BP+3]
  mov R2, [global_bmapheight]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15249:
  jf R0, __if_15236_end
  mov R0, 1
...
__if_15285_start:
  ...
  mov R1, [global_validcount]
  ieq R0, R1
  jf R0, __if_15285_end
  jmp __for_15269_continue
__if_15285_end:
  mov R0, [global_validcount]
  mov R1, [BP-3]
  iadd R1, 14
...
__if_15295_start:
  ...
  bnot R1
  mov R0, R1
  jf R0, __if_15295_end
  mov R0, 0
  jmp __function_P_BlockLinesIterator_return
__if_15295_end:
__for_15269_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_15269_start
__for_15269_end:
  mov R0, 1
...
__if_15310_start:
  mov R0, [BP+2]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_15315
  mov R1, [BP+3]
  ilt R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_15315:
  jt R0, __LogicalOr_ShortCircuit_15319
  mov R1, [BP+2]
  mov R2, [global_bmapwidth]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15319:
  jt R0, __LogicalOr_ShortCircuit_15323
  mov R1, [BP+3]
  mov R2, [global_bmapheight]
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_15323:
  jf R0, __if_15310_end
  mov R0, 1
...
__if_15345_start:
  ...
  bnot R1
  mov R0, R1
  jf R0, __if_15345_end
  mov R0, 0
  jmp __function_P_BlockThingsIterator_return
__if_15345_end:
__for_15328_continue:
  mov R1, [BP-1]
  iadd R1, 9
  mov R0, [R1]
  mov [BP-1], R0
  jmp __for_15328_start
__for_15328_end:
  mov R0, 1
...
__if_15375_start:
  mov R0, [1706527]
  igt R0, 1048576
  jt R0, __LogicalOr_ShortCircuit_15384
  mov R1, [1706528]
  igt R1, 1048576
  or R0, R1
__LogicalOr_ShortCircuit_15384:
  jt R0, __LogicalOr_ShortCircuit_15391
  mov R1, [1706527]
  ilt R1, -1048576
  or R0, R1
__LogicalOr_ShortCircuit_15391:
  jt R0, __LogicalOr_ShortCircuit_15399
  mov R1, [1706528]
  ilt R1, -1048576
  or R0, R1
__LogicalOr_ShortCircuit_15399:
  jf R0, __if_15375_else
  mov R4, [BP+2]
  mov R3, [R4]
  mov R2, [R3]
  mov [SP], R2
...
__if_15474_start:
  ...
  jf R0, __LogicalAnd_ShortCircuit_15476
  mov R1, [BP-3]
  ilt R1, 65536
  and R0, R1
__LogicalAnd_ShortCircuit_15476:
  jf R0, __LogicalAnd_ShortCircuit_15483
  mov R2, [BP+2]
  iadd R2, 16
  mov R1, [R2]
  ine R1, -1
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_15483:
  jf R0, __if_15474_end
  mov R0, 0
  jmp __function_PIT_AddLineIntercepts_return
__if_15474_end:
__if_15486_start:
...
__function_P_TraverseIntercepts:
  ...
  mov [BP-1], R0
__while_15710_start:
__while_15710_continue:
  mov R0, [BP-1]
  mov R1, R0
  isub R1, 1
  mov [BP-1], R1
  cib R0
  jf R0, __while_15710_end
  mov R0, 2147483647
  mov [BP-2], R0
  mov R0, 0
  mov [BP-3], R0
...
__if_15727_start:
  ...
  mov [BP-4], R0
__if_15727_end:
__for_15717_continue:
  mov R0, [BP-3]
  mov R1, R0
  iadd R1, 1
  mov [BP-3], R1
  jmp __for_15717_start
__for_15717_end:
__if_15747_start:
  mov R0, [BP-2]
  mov R1, [BP+3]
...
__if_16895_start:
  ...
  mov R1, [global_validcount]
  ieq R0, R1
  jf R0, __if_16895_end
  jmp __for_16872_continue
__if_16895_end:
  mov R0, [global_validcount]
  mov R1, [BP-2]
  iadd R1, 14
...
__if_17000_start:
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_17008
  mov R2, [BP-7]
  iadd R2, 1
  mov R1, [R2]
  mov R3, [BP-8]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_17008:
  jf R0, __if_17000_end
  jmp __for_16872_continue
__if_17000_end:
__if_17013_start:
  mov R1, [BP-7]
...
__if_17096_start:
  ...
  jmp __function_P_CrossSubsector_return
__if_17096_end:
__for_16872_continue:
  mov R0, [BP-19]
  mov R1, R0
  iadd R1, 1
  mov [BP-19], R1
  jmp __for_16872_start
__for_16872_end:
  mov R0, 1
...
__if_17329_start:
  mov R0, [BP+2]
  bnot R0
  jf R0, __if_17329_end
  mov R0, 0
  mov [global_AllPassed], R0
__if_17336_start:
  mov R0, [global_firstFail]
  ieq R0, 0
  jf R0, __if_17336_end
  mov R0, [global_checkNum]
  mov [global_firstFail], R0
__if_17336_end:
__if_17329_end:
...
__for_17388_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17388_start
__for_17388_end:
  mov R0, 0
  mov [BP-1], R0
__for_17408_start:
...
__for_17408_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17408_start
__for_17408_end:
  mov R0, 0
  mov [BP-1], R0
__for_17468_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17468_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17468_start
__for_17468_end:
  mov R0, 0
  mov [BP-1], R0
__for_17486_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17486_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17486_start
__for_17486_end:
  mov R0, 0
  mov [BP-1], R0
__for_17504_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_17504_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17504_start
__for_17504_end:
  ...
  mov R1, [BP-4]
  igt R1, 65520
  jf R1, __LogicalAnd_ShortCircuit_17570
  mov R2, [BP-4]
  ilt R2, 65552
  and R1, R2
__LogicalAnd_ShortCircuit_17570:
  mov [SP], R1
  call __function_Check
  mov R0, -1073741824
  mov [BP-5], R0
  ...
  mov R1, [BP-10]
  ieq R1, 0x80000000
  jf R1, __LogicalAnd_ShortCircuit_17649
  mov R2, [BP-8]
  ieq R2, 2147483647
  and R1, R2
__LogicalAnd_ShortCircuit_17649:
  mov [SP], R1
  call __function_Check
  lea R1, [BP-10]
  mov [SP], R1
  ...
  mov R1, [BP-8]
  ieq R1, -50
  jf R1, __LogicalAnd_ShortCircuit_17671
  mov R2, [BP-7]
  ieq R2, 0x80000000
  and R1, R2
__LogicalAnd_ShortCircuit_17671:
  mov [SP], R1
  call __function_Check
  lea R1, [BP-10]
  mov [SP], R1
...
__LogicalAnd_ShortCircuit_17687:
  jf R1, __LogicalAnd_ShortCircuit_17693
  mov R2, [BP-10]
  ieq R2, 300
  and R1, R2
__LogicalAnd_ShortCircuit_17693:
  mov [SP], R1
  call __function_Check
  ...
  mov R1, [R1]
  ieq R1, 0
  jf R1, __LogicalAnd_ShortCircuit_17745
  mov R2, [BP-15]
  iadd R2, 199
  mov R2, [R2]
  ieq R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_17745:
  mov [SP], R1
  call __function_Check
  mov R1, 50
  mov [SP], R1
...
__if_17822_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17835
  mov R1, __embedded_gen_segs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 467
  or R0, R1
__LogicalOr_ShortCircuit_17835:
  jf R0, __if_17822_end
  mov R0, 0
  mov [BP-16], R0
__if_17822_end:
__if_17841_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17854
  mov R1, __embedded_gen_segs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 467
  or R0, R1
__LogicalOr_ShortCircuit_17854:
...
__if_17860_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17873
  mov R1, __embedded_gen_segs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 475
  or R0, R1
__LogicalOr_ShortCircuit_17873:
  jf R0, __if_17860_end
  mov R0, 0
  mov [BP-16], R0
__if_17860_end:
__for_17812_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17812_start
__for_17812_end:
  mov R1, [BP-16]
  mov [SP], R1
  call __function_Check
...
__if_17894_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17907
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 85
  or R0, R1
__LogicalOr_ShortCircuit_17907:
...
__if_17913_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17926
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17926:
  jf R0, __if_17913_end
  mov R0, 0
  mov [BP-17], R0
__if_17913_end:
__if_17932_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17945
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17945:
...
__if_17951_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_17964
  mov R1, __embedded_gen_sidedefs
  mov R2, [BP-1]
  imul R2, 6
  iadd R1, R2
  ...
  ige R1, 125
  or R0, R1
__LogicalOr_ShortCircuit_17964:
  jf R0, __if_17951_end
  mov R0, 0
  mov [BP-17], R0
__if_17951_end:
__for_17884_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_17884_start
__for_17884_end:
  mov R1, [BP-17]
  mov [SP], R1
  call __function_Check
...
__for_18254_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_18254_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18254_start
__for_18254_end:
...
__if_18312_start:
  ...
  mov R0, [R1]
  ieq R0, -1
  jf R0, __if_18312_end
  mov R0, 0
  mov [BP-18], R0
__if_18312_end:
__for_18303_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18303_start
__for_18303_end:
  mov R1, [BP-18]
  mov [SP], R1
  call __function_Check
...
__if_18339_start:
  ...
  mov [BP-20], R0
__if_18339_end:
__for_18330_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18330_start
__for_18330_end:
  mov R1, [BP-19]
  ine R1, 0
  jt R1, __LogicalOr_ShortCircuit_18371
  mov R2, [BP-20]
  ine R2, 0
  or R1, R2
__LogicalOr_ShortCircuit_18371:
  mov [SP], R1
  call __function_Check
  mov R1, [BP-19]
  mov [SP], R1
...
__for_18405_start:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_18405_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18405_start
__for_18405_end:
  mov R1, __embedded_gen_states
  iadd R1, 98
  iadd R1, 1
...
__if_18532_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18545
  mov R1, __embedded_gen_states
  mov R2, [BP-1]
  imul R2, 7
  iadd R1, R2
  ...
  ige R1, 138
  or R0, R1
__LogicalOr_ShortCircuit_18545:
  jf R0, __if_18532_end
  mov R0, 0
  mov [BP-22], R0
__if_18532_end:
__if_18551_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18564
  mov R1, __embedded_gen_states
  mov R2, [BP-1]
  imul R2, 7
  iadd R1, R2
  ...
  ige R1, 967
  or R0, R1
__LogicalOr_ShortCircuit_18564:
...
__if_18570_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18583
  mov R1, __embedded_gen_states
  mov R2, [BP-1]
  imul R2, 7
  iadd R1, R2
  ...
  ige R1, 75
  or R0, R1
__LogicalOr_ShortCircuit_18583:
  jf R0, __if_18570_end
  mov R0, 0
  mov [BP-22], R0
__if_18570_end:
__for_18522_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18522_start
__for_18522_end:
  mov R1, [BP-22]
  mov [SP], R1
  call __function_Check
...
__if_18634_end:
  ...
  mov [SP+1], R1
  call __function_CheckEq
__for_18591_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18591_start
__for_18591_end:
...
__if_18688_start:
  ...
  mov R0, [R0]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_18697
  mov R1, global_viewangletox
  mov R2, [BP-1]
  iadd R1, R2
  mov R1, [R1]
  ...
  igt R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_18697:
  jf R0, __if_18688_end
  mov R0, 0
  mov [BP-23], R0
__if_18688_end:
__for_18665_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_18665_start
__for_18665_end:
  mov R1, [BP-23]
  mov [SP], R1
  call __function_Check
...
__if_18710_end:
  ...
  call __function_Check
__while_18724_start:
__while_18724_continue:
  mov R0, 1
  jf R0, __while_18724_end
__if_18727_start:
  mov R0, [global_AllPassed]
  jf R0, __if_18727_else
  mov R1, -16711936
  mov [SP], R1
...
__literal_string_18735:
  string "VIRCONDOOM CORE ALL GREEN"
__literal_string_18739:
  string "TOTAL CHECKS"
__literal_string_18750:
  string "CORE FAIL - FIRST FAIL CHECK"
__literal_string_18758:
  string "EXPECTED"
__literal_string_18766:
  string "ACTUAL"
__literal_string_18774:
  string "TOTAL CHECKS"
