...
def main():
    ...
    # ---- music: no baked WAV. The live synth event player (port/mus_player.h,
    # data generated by tools/gen_music.py) replaces the old 17MB music_e1m1.vsnd.
    # music_id = -1 leaves that sound_id free so the wavetables below sit right
    # after the sfx (GEN_WAVE_BASE == number of sfx sounds).
    music_id = -1
